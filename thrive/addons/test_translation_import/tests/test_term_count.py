...
from thrive.tools.misc import file_open, mute_logger, file_path
from thrive.tools.translate import TranslationModuleReader, TranslationRecordReader, code_translations, CodeTranslations, PYTHON_TRANSLATION_COMMENT, JAVASCRIPT_TRANSLATION_COMMENT, TranslationFileReader
...
class TestTranslationFlow(common.TransactionCase):
    ...
    def test_export_spreadsheet_new_dataset(self):
        ...
        self.assertEqual(set(terms), {
            ...
            'Scorecard title',
            'Opportunities',
            'Thrive Chart horizontal axis title',
            'Thrive Chart vertical axis title'
        })
