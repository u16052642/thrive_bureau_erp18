...
from thrive.addons.base.tests.test_expression import TransactionExpressionCase
from thrive.exceptions import AccessError, MissingError, UserError, ValidationError
from thrive.tests import TransactionCase, tagged, Form, users
...
%endif"""
    ...
    @patch('thrive.fields.html_sanitize', return_value='<p>comment</p>')
