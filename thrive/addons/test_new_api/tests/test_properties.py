...
from thrive.tests import Form, TransactionCase, users
...
class PropertiesCase(TestPropertiesMixin):
    ...
    def test_properties_field_security(self):
        ...
        self.env.invalidate_all()
        with patch('thrive.addons.test_new_api.models.test_new_api.MultiTag.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        ...
        self.env.invalidate_all()
        with patch('thrive.addons.test_new_api.models.test_new_api.Discussion.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        self.assertEqual(values['value'], (tag.id, 'Test Tag'))
