...
from thrive.tools.misc import mute_logger, file_open
...
class TestUi(thrive.tests.HttpCase, SignRequestCommon):
    def test_ui(self):
        ...
        self.start_tour("/thrive", 'sign_widgets_tour', login='admin')

        self.start_tour("/thrive", 'shared_sign_request_tour', login='admin')
    ...
    def test_sign_flow(self):
        ...
        self.start_tour("/thrive", 'test_sign_flow_tour', login='admin')
    ...
    def test_template_edition(self):
        ...
        self.start_tour("/thrive", "sign_template_creation_tour", login="admin")
    ...
    def test_report_modal(self):
        self.start_tour("/thrive", "sign_report_modal_tour", login="admin")
