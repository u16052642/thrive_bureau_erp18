...
from thrive.addons.payment_worldline.controllers.main import WorldlineController
from thrive.addons.payment_worldline.tests.common import WorldlineCommon


@tagged('post_install', '-at_install')
class WorldlineTest(WorldlineCommon, PaymentHttpCommon):

    @mute_logger('thrive.addons.payment_worldline.controllers.main')
    def _webhook_notification_flow(self, payload):
        ...
        with patch(
            'thrive.addons.payment_worldline.controllers.main.WorldlineController'
