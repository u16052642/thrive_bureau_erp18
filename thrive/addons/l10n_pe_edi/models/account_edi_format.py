...
from thrive.tools.zeep.wsse.username import UsernameToken
from thrive.tools.zeep import Client, Settings
...
from thrive.tools import _, LazyTranslate, html_escape
    ...
    def _l10n_pe_edi_get_cdr_error_messages(self):
        ...
        return {
            ...
            '154': _lt("Your RUC is not linked to Digiflow as OSE, please make sure you have follow this process in the SUNAT portal:\n"
                       ...
                       "Reference: \n"
                       "https://www.thrivebureau.com/documentation/master/applications/finance/accounting/fiscal_localizations/localizations/peru.html#what-do-you-need-to-do"),
