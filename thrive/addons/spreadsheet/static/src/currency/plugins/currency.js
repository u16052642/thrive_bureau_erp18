...
import { EvaluationError, helpers, registries } from "@thrive/o-spreadsheet";
...
export class CurrencyPlugin extends ThriveUIPlugin {
    ...
    constructor(config) {
        ...
        this._serverData = config.custom.thriveDataProvider?.serverData;
    }

    get serverData() {
        if (!this._serverData) {
            throw new Error(
                "'serverData' is not defined, please make sure a 'ThriveDataProvider' instance is provided to the model."
            );
        }
