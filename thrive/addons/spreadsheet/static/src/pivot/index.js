...
import { PivotThriveCorePlugin } from "./plugins/pivot_thrive_core_plugin";
...
inverseCommandRegistry.add("UPDATE_THRIVE_PIVOT_DOMAIN", identity);

export { PivotThriveCorePlugin, PivotUIGlobalFilterPlugin };
