...
import { helpers, constants, EvaluationError, SpreadsheetPivotTable } from "@thrive/o-spreadsheet";
...
/**
 * @typedef {import("@thrive/o-spreadsheet").PivotTableColumn} PivotTableColumn
 * @typedef {import("@thrive/o-spreadsheet").PivotTableRow} PivotTableRow
 ...
 */
export class ThrivePivotModel extends PivotModel {
    /**
     * @param {import("@web/env").ThriveEnv} env
     * @param {import("@spreadsheet").ThrivePivotModelParams} params
    ...
    /**
     * @param {import("@thrive/o-spreadsheet").PivotDimension} dimension
