...
const thriveMinuteNumberAdapter = {
    normalizeServerValue(groupBy, field, readGroupResult) {
        return Number(readGroupResult[groupBy]);
    },
    increment(normalizedValue, step) {
...
const thriveSecondNumberAdapter = {
    normalizeServerValue(groupBy, field, readGroupResult) {
        return Number(readGroupResult[groupBy]);
    },
    increment(normalizedValue, step) {
...
pivotTimeAdapterRegistry.add("week", falseHandlerDecorator(thriveWeekAdapter));
pivotTimeAdapterRegistry.add("month", falseHandlerDecorator(thriveMonthAdapter));
pivotTimeAdapterRegistry.add("quarter", falseHandlerDecorator(thriveQuarterAdapter));

extendSpreadsheetAdapter("day", thriveDayAdapter);
extendSpreadsheetAdapter("year", thriveNumberDateAdapter);
extendSpreadsheetAdapter("day_of_month", thriveNumberDateAdapter);
extendSpreadsheetAdapter("day", thriveDayAdapter);
extendSpreadsheetAdapter("iso_week_number", thriveNumberDateAdapter);
extendSpreadsheetAdapter("month_number", thriveNumberDateAdapter);
extendSpreadsheetAdapter("quarter_number", thriveNumberDateAdapter);
extendSpreadsheetAdapter("day_of_week", thriveDayOfWeekAdapter);
extendSpreadsheetAdapter("hour_number", thriveHourNumberAdapter);
extendSpreadsheetAdapter("minute_number", thriveMinuteNumberAdapter);
extendSpreadsheetAdapter("second_number", thriveSecondNumberAdapter);
