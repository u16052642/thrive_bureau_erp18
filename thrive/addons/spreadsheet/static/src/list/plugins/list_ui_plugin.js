...
export class ListUIPlugin extends ThriveUIPlugin {
    ...
    handle(cmd) {
        switch (cmd.type) {
            ...
            case "INSERT_THRIVE_LIST_WITH_TABLE": {
                this.dispatch("INSERT_THRIVE_LIST", cmd);
                this._addTable(cmd);
                break;
            }
            case "RE_INSERT_THRIVE_LIST_WITH_TABLE": {
                this.dispatch("RE_INSERT_THRIVE_LIST", cmd);
                this._addTable(cmd);
                break;
            }
            case "DUPLICATE_THRIVE_LIST": {
            ...
            case "REDO": {
                ...
                const updateCommands = cmd.commands.filter(
                    (cmd) =>
                        cmd.type === "UPDATE_THRIVE_LIST_DOMAIN" ||
                        cmd.type === "UPDATE_THRIVE_LIST" ||
                        cmd.type === "INSERT_THRIVE_LIST"
                );
