...
/**
 * @param {import("@thrive/o-spreadsheet").CellPosition} position
...
/**
 * @param {import("@thrive/o-spreadsheet").CellPosition} position
 * @param {import("@spreadsheet").ThriveGetters} getters
 * @returns {boolean}
 */
export const SEE_RECORD_LIST_VISIBLE = (position, getters) => {
    ...
    return (
        ...
        getFirstListFunction(cell.compiledFormula.tokens).functionName === "THRIVE.LIST"
    );
};
