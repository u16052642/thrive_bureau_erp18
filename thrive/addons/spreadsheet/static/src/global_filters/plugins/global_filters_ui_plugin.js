...
export class GlobalFiltersUIPlugin extends ThriveUIPlugin {
    ...
    constructor(config) {
        ...
        this.thriveDataProvider = config.custom.thriveDataProvider;
        /**
        ...
        switch (filter.type) {
            ...
            case "relation":
                ...
                if (!this.recordsDisplayName[filter.id]) {
                    ...
                    this.thriveDataProvider.notifyWhenPromiseResolves(promise);
                    return [[{ value: "" }]];
                }
