 ...
 * @property {ThriveFields} [fields]
 *
 * @typedef {Object} ThriveModelSearchParams
...
export class ThriveViewsDataSource extends LoadableDataSource {
    ...
    /**
     * @returns {ThriveFields} List of fields
     */
    getFields() {
     ...
     * @returns {ThriveField | undefined} Field
     */
    getField(field) {
        this._assertMetaDataLoaded();
