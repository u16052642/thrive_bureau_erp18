 ...
 * @typedef {import("@spreadsheet/helpers/model").ThriveSpreadsheetModel} ThriveSpreadsheetModel
...
export function setupDataSourceEvaluation(model) {
    model.config.custom.thriveDataProvider.addEventListener("data-source-updated", () => {
 ...
 * @returns {Promise<ThriveSpreadsheetModel>}
 */
