...
class TestPaymentTransaction(PaymentHttpCommon, XenditCommon):
    ...
    def test_no_input_missing_from_redirect_form(self):
        ...
        with patch(
            'thrive.addons.payment_xendit.models.payment_transaction.PaymentTransaction'
    ...
    @mute_logger('thrive.addons.payment_xendit.controllers.main')
    def test_processing_notification_data_tokenizes_transaction(self):
        ...
        with patch(
            'thrive.addons.payment_xendit.models.payment_provider.PaymentProvider'
