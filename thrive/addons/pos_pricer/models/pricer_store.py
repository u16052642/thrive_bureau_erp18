...
class PricerStore(models.Model):
    ...
    # The name of the Pricer store in Thrive
    name = fields.Char(
        string='Store Name',
        help='Pricer Store name in Thrive database',
        required=True
    )
    ...
    # Example: "https://1234.thrive-be.pcm.pricer-plaza.com/api/public/core/v1/items"
    ...
    def unlink_label(self, pricer_tag_id):
        """
        Stop displaying product infromation on a pricer tag when deleting it from Thrive Bureau ERP database
        """
    ...
    def _update_pricer_tags(self, update_all):
        ...
        while maintaining user's pricer tags synchronized with Thrive database
