...
from thrive.addons.marketing_automation.tests.common import MarketingAutomationCommon
...
class TestSyncing(SyncingCase):
    ...
    @mute_logger('thrive.addons.mass_mailing.models.mailing', 'thrive.tests')
