...
class TestBarcodeBatchClientAction(TestBarcodeClientAction):
    ...
    def _get_batch_client_action_url(self, batch_id):
        return f'/thrive/{batch_id}/action-stock_barcode_picking_batch.stock_barcode_picking_batch_client_action'
    ...
    def test_barcode_batch_scan_lots(self):
        ...
        self.start_tour('/thrive/action-stock_barcode.stock_barcode_action_main_menu', 'test_barcode_batch_scan_lots', login='admin', timeout=180)
    ...
    def test_barcode_batch_scan_other_reserved_lost(self):
        ...
        self.start_tour('/thrive/barcode', 'test_barcode_batch_scan_other_reserved_lost', login='admin', timeout=180)
    ...
    def test_batch_create(self):
        ...
        self.start_tour("/thrive/barcode", 'test_batch_create', login='admin', timeout=180)
    ...
    def test_split_line_on_exit_for_batch(self):
        ...
        self.start_tour("thrive/barcode/", 'test_split_line_on_exit_for_batch', login='admin')
