...
from thrive import api, Command, fields, models, tools, SUPERUSER_ID, _
...
from thrive.tools import format_list, SQL
from thrive.addons.resource.models.utils import filter_domain_leaf
from thrive.addons.project.controllers.project_sharing_chatter import ProjectSharingChatter
...
class Task(models.Model):
    ...
    def action_redirect_to_project_task_form(self):
        ...
        return {
            'type': 'ir.actions.act_url',
            'url': f"/thrive/1/action-project.act_project_project_2_project_task_all/{self.id}?menu_id={menu_id}",
            'target': 'new',
        }
