...
from thrive.addons.website_sale_autocomplete.controllers.main import AutoCompleteController
from thrive.tests import patch, HttpCase, tagged

CONTROLLER_PATH = 'thrive.addons.website_sale_autocomplete.controllers.main.AutoCompleteController'
