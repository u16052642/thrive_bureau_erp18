...
class L10nBeHrPayrollExportGroupS(models.Model):
    ...
    def _compose_group_s_starter(self):
        ...
        [44]       - 1      - filler
        [45]       - 20     - ASCII     - maker name            (THRIVE)           - no need to use filler
        ```
        eg: 000PTG001202405171618120000654321EUR  000001 THRIVE
        """
        ...
        return '000' + 'PTG' + '002' + create_date + affiliation_number + 'EUR ' + ' ' * 8 + 'THRIVE' + '\n'
