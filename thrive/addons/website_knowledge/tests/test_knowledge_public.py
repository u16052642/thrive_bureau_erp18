...
class TestKnowledgePublic(HttpCase):
    ...
    def test_knowledge_meta_tags(self):
        ...
        article = self.env['knowledge.article'].create({
            ...
            'body': '''
                <h1>What is Thrive Experience?</h1>
                <div data-embedded="tableOfContent">Hello</div>
                <p>Thrive Experience is our largest event, taking place once a year.</p>
                <p>It brings together all members of the Thrive sphere, including partners, customers and open source software fans.</p>
            ''',
        ...
        self.assertEqual(
            article.summary,
            'What is Thrive Experience? Thrive Experience is our largest event, taking place once a year. It brings t...')
