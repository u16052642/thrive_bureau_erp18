...
from thrive import SUPERUSER_ID, _, http, api
...
from thrive.tools import file_open, file_path, replace_exceptions, str2bool
    ...
    def company_logo(self, dbname=None, **kw):
        ...
        if not dbname:
            ...
            try:
                ...
                _logger.warning("While retrieving the company logo, using the Thrive logo instead", exc_info=True)
