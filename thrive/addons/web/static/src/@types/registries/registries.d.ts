declare module "registries" {
    ...
    export type ActionsRegistryItemShape = (((env: ThriveEnv, action: ActionDescription) => void) | typeof Component) & {
        displayName?: string;
        path?: string;
        target?: ActionMode;
    };
    ...
    export interface CogMenuRegistryItemShape {
        ...
        groupNumber: number;
        isDisplayed?: (env: ThriveEnv) => boolean;
    }

    export type DialogsRegistryItemShape = typeof Component;

    export type EffectsRegistryItemShape = (env: ThriveEnv, params: object) => ({ Component: typeof Component, props: object } | undefined);

    export type ErrorDialogsRegistryItemShape = typeof Component;

    export type ErrorHandlersRegistryItemShape = (env: ThriveEnv, error: Error, originalError: Error) => boolean;
    ...
    export type IrActionsReportHandlers = (action: ActionRequest, options: ActionOptions, env: ThriveEnv) => (void | boolean | Promise<void | boolean>);
