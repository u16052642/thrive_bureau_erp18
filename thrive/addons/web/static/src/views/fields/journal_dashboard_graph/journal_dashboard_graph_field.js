...
export class JournalDashboardGraphField extends Component {
    ...
    getLineChartConfig() {
        ...
        const color10 = getColor(3, cookie.get("color_scheme"), "thrive");
    ...
    getBarChartConfig() {
        ...
        const color13 = getColor(2, cookie.get("color_scheme"), "thrive");
        const color19 = getColor(1, cookie.get("color_scheme"), "thrive");
