...
(function () {
    ...
    class ModuleLoader {
         ...
         * @type {typeof thrive.loader.factories}
         */
        factories = new Map();
        /**
         * Names of modules waiting to be started
         * @type {typeof thrive.loader.jobs}
         */
        jobs = new Set();
        /**
         * Names of failed modules
         * @type {typeof thrive.loader.failed}
         */
        failed = new Set();
        /**
         * Mapping name => value
         * @type {typeof thrive.loader.modules}
         */
        modules = new Map();
        ...
        define(name, deps, factory, lazy = false) {
            ...
            this.factories.set(name, {
                deps,
                fn: factory,
                ignoreMissingDeps: globalThis.__thriveIgnoreMissingDependencies || lazy,
            });
            if (!lazy) {
                this.addJob(name);
