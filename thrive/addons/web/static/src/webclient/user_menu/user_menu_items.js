...
function documentationItem(env) {
    const documentationURL = "http://support.thrivebureau.com/knowledge/";
    return {
        type: "item",
        id: "documentation",
...
export function thriveAccountItem(env) {
    return {
        type: "item",
        id: "account",
        ...
        callback: () => {
            rpc("/web/session/account")
                ...
                .catch(() => {
                    browser.open("https://thrivebureaucrm.com/web/login?", "_blank");
                });
        },
        sequence: 60,
    };
