...
import { Component, useRef, useState, markup } from "@thrive/owl";
...
export const thriveExceptionTitleMap = new Map(
    Object.entries({
        ...
        "thrive.addons.web.controllers.action.MissingActionError": _t("Missing Action"),
...
registry
    ...
    .add("thrive.addons.web.controllers.action.MissingActionError", WarningDialog)
