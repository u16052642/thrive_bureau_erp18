import { after, expect, getFixture } from "@thrive/hoot";
import { click, formatXml, queryAll, queryAllTexts } from "@thrive/hoot-dom";
import { animationFrame, Deferred, tick } from "@thrive/hoot-mock";
import { Component, onMounted, useSubEnv, xml } from "@thrive/owl";
 ...
 * }} SelectorOptions
 *
 * @typedef {import("@thrive/hoot-dom").FormatXmlOptions} FormatXmlOptions
