import { after, afterEach, beforeEach, registerDebugInfo } from "@thrive/hoot";
 ...
 *
 * @param {Partial<ThriveEnv>} [partialEnv]
 */
 ...
 *  (env: ThriveEnv, dependencies: Dependencies) => Services[T]
 * } serviceFactory
 */
