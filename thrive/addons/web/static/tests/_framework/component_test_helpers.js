import { after, getFixture, mountOnFixture } from "@thrive/hoot";
 ...
 *
 * @param {import("@thrive/hoot-dom").Target} togglerSelector
 ...
 *
 * @template {import("@thrive/owl").ComponentConstructor<P, E>} C
 * @template [P={}]
 * @template [E=import("@web/env").ThriveEnv]
