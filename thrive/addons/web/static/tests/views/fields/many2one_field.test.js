...
import { click, press, queryAll, queryAllTexts, queryOne, scroll } from "@thrive/hoot-dom";
import { Deferred, animationFrame, runAllTimers } from "@thrive/hoot-mock";
...
test("many2one in non edit mode (with value)", async () => {
    ...
    expect("div[name=res_trululu] a.o_form_uri").toHaveAttribute("href", "/thrive/res.partner/1");
    expect("div[name=trululu] a.o_form_uri").toHaveAttribute("href", "/thrive/m-partner/4");
});
