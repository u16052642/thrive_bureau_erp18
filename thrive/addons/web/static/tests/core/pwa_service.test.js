...
import { mockFetch } from "@thrive/hoot-mock";
...
test("PWA installation process", async () => {
    ...
    expect(pwaService.canPromptToInstall).toBe(false);
    expect.verifySteps(['{"/thrive":"accepted"}', "onDone call with installation accepted"]);
});
