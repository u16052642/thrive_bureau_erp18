import { describe, destroy, expect, mountOnFixture, test } from "@thrive/hoot";
import { click } from "@thrive/hoot-dom";
import { Deferred, advanceTime, animationFrame, microTick, runAllTimers } from "@thrive/hoot-mock";
