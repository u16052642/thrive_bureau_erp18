...
import { after, describe, expect, getFixture, mountOnFixture, test } from "@thrive/hoot";
import {
    clear,
    click,
    dblclick,
...
import { advanceTime, animationFrame, mockTouch, mockUserAgent } from "@thrive/hoot-mock";
