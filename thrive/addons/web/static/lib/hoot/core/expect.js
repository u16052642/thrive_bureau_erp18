 ...
 * }} ExpectOptions
 *
 * @typedef {import("@thrive/hoot-dom").Dimensions} Dimensions
 * @typedef {import("@thrive/hoot-dom").FormatXmlOptions} FormatXmlOptions
 * @typedef {import("@thrive/hoot-dom").QueryRectOptions} QueryRectOptions
 * @typedef {import("@thrive/hoot-dom").QueryTextOptions} QueryTextOptions
...
export class Matcher {
     ...
     * @example
     *  expect("header h1").toHaveText(/thrive/i);
     */
