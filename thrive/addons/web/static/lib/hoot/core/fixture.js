...
/**
 * @typedef {{
 *  component: import("@thrive/owl").ComponentConstructor;
 *  props: unknown;
 * }} TestRootProps
 */
...
export function makeFixtureManager(runner) {
    ...
    /**
     * @param {Parameters<typeof import("@thrive/owl").mount>[0]} ComponentClass
     * @param {Parameters<typeof import("@thrive/owl").mount>[2]} config
     * @param {Parameters<typeof import("@thrive/owl").mount>[1]} [target]
     */
