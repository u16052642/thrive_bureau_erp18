    ...
    def test_01_click_everywhere_as_admin(self):
        ...
        for app_id in menus['root']['children']:
            with self.subTest(app=menus[app_id]['name']):
                ...
                self.browser_js("/thrive", "thrive.loader.modules.get('@web/webclient/clickbot/clickbot_loader').startClickEverywhere('%s');" % menus[app_id]['xmlid'], "thrive.isReady === true", login="admin", timeout=1200, success_signal="clickbot test succeeded")
...
class TestMenusDemo(HttpCaseWithUserDemo):
    ...
    def test_01_click_everywhere_as_demo(self):
        ...
        for app_id in menus['root']['children']:
            with self.subTest(app=menus[app_id]['name']):
                _logger.runbot('Testing %s', menus[app_id]['name'])
                self.browser_js("/thrive", "thrive.loader.modules.get('@web/webclient/clickbot/clickbot_loader').startClickEverywhere('%s');" % menus[app_id]['xmlid'], "thrive.isReady === true", login="demo", timeout=1200, success_signal="clickbot test succeeded")
...
class TestMenusAdminLight(thrive.tests.HttpCase):
    ...
    def test_01_click_apps_menus_as_admin(self):
        ...
        self.browser_js("/thrive", "thrive.loader.modules.get('@web/webclient/clickbot/clickbot_loader').startClickEverywhere(undefined, true);", "thrive.isReady === true", login="admin", timeout=120, success_signal="clickbot test succeeded")
...
class TestMenusDemoLight(HttpCaseWithUserDemo):
    ...
    def test_01_click_apps_menus_as_demo(self):
        ...
        self.browser_js("/thrive", "thrive.loader.modules.get('@web/webclient/clickbot/clickbot_loader').startClickEverywhere(undefined, true);", "thrive.isReady === true", login="demo", timeout=120, success_signal="clickbot test succeeded")
