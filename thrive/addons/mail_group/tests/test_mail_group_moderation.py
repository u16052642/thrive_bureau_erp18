...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('thrive.models.unlink', 'thrive.addons.mail_group.models.mail_group_message')
    @users('employee')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('thrive.addons.mail.models.mail_thread', 'thrive.addons.mail_group.models.mail_group_message', 'thrive.models.unlink')
    @users('employee')
    ...
    @mute_logger('thrive.addons.mail_group.models.mail_group')
    @users('employee')
