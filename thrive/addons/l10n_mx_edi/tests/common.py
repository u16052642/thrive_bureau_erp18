...
from thrive.tools.zeep.client import SERIALIZABLE_TYPES
...
class TestMxEdiCommon(AccountTestInvoicingCommon):
    ...
    def mx_external_setup(self, date_obj):
        ...
        with freeze_time(date_obj), patch('thrive.tools.zeep.client.SERIALIZABLE_TYPES', SERIALIZABLE_TYPES + (FakeDatetime,)):
            yield
