...
from thrive.tools import format_list, frozendict
...
class AccountMove(models.Model):
    ...
    def _l10n_mx_edi_cfdi_invoice_post_cancel(self):
        ...
        - The user can request a cancellation from Thrive Bureau ERP.
        - The user can cancel the invoice from the SAT, then update the SAT state in Thrive.
        """
    ...
    def _l10n_mx_edi_cfdi_payment_post_cancel(self):
        ...
        - The user can request a cancellation from Thrive Bureau ERP.
        - The user can cancel the payment from the SAT, then update the SAT state in Thrive.
        """
        self._l10n_mx_edi_cfdi_move_post_cancel()
