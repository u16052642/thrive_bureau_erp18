...
from thrive.addons.payment_mollie.tests.common import MollieCommon
...
class MollieTest(MollieCommon, PaymentHttpCommon):
    ...
    @mute_logger(
        'thrive.addons.payment_mollie.controllers.main',
        'thrive.addons.payment_mollie.models.payment_transaction',
    )
    def test_webhook_notification_confirms_transaction(self):
        ...
        with patch(
            'thrive.addons.payment_mollie.models.payment_provider.PaymentProvider'
