...
Configure Thrive VOIP
==========================

In Thrive, the configuration should be done in the user's preferences.
...
The external device number is not a required field but it is used if you want to transfer your call from Thrive Bureau ERP to an external phone also configured in the sip.conf file.
