...
from thrive.tests.common import new_test_user, Like
...
class TestHttpModels(TestHttpBase):
    ...
    def test_models5_stargate_setname_readonly(self):
        ...
        with self.assertLogs('thrive.http', 'WARNING') as capture_http,\
             self.assertLogs('thrive.sql_db', 'WARNING') as capture_sql_db:
