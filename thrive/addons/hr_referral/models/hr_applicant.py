...
class Applicant(models.Model):
    ...
    def _send_notification(self, body, action_value='hr_referral.action_hr_applicant_employee_referral'):
        ...
        action_url = f'/thrive/action-{action_value}?active_model={self._name}'
        ...
        # Increase stage sequence
            ...
            if gained_points > 0:
                additional_message = escape(_(
                    ...
                    link1=Markup('<a href="/thrive/action-hr_referral.action_hr_referral_reward?active_model=hr.referral.reward">'),
                    link2=Markup('</a>'),
                )
    ...
    def retrieve_referral_welcome_screen(self):
        ...
        for message in messages:
            ...
            if message.onclick == 'url':
                ...
                msg['url'] = '/thrive/action-hr_referral.action_hr_job_employee_referral'
