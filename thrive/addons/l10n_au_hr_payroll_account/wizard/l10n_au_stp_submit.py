...
class L10nAuSTPSubmit(models.TransientModel):
    ...
    stp_terms = fields.Boolean(
        ...
        "I authorise Thrive to send compliant payroll data to the ATO on my behalf.",
        default=False)
...
<ul>
    ...
    <li class="p-2">
        I understand that while Thrive is a tool that can be used for Australian companies to be compliant with
        STP Phase 2 and SuperStream obligations, Thrive AU Pty Ltd does not provide agent services nor business advice.
