...
from thrive.tests import Form, tagged, new_test_user
...
class TestPayrollSuperStream(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.employee = cls.env['hr.employee'].create({
            ...
            'l10n_au_payroll_id': 'thrive_f47ac10b_001',
            'gender': 'male',
        })
        ...
        cls.australian_company.l10n_au_hr_super_responsible_id = cls.env["hr.employee"].create({
            ...
            # "l10n_au_previous_payroll_id": "thrive_f47ac10b_001",
    ...
    def get_expected_lines(self, super_values: list):
        ...
        for idx, value in enumerate(super_values):
            ...
            "Federer", "Roger", "", "1", "1970-03-21", "RES", "Australian Street", "", "", "", "Sydney", "2000", "NSW", "AU", "roger@gmail.com", "123456789", "123456789", "", "thrive_f47ac10b_001",
