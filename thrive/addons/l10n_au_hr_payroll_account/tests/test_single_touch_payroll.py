...
from thrive.addons.l10n_au_hr_payroll.tests.test_unused_leaves import TestPayrollUnusedLeaves
...
class TestSingleTouchPayroll(L10nPayrollAccountCommon):
    ...
    def setUpClass(cls):
        ...
        cls.company.l10n_au_bms_id = "THRIVE_TEST_BMS_ID"
        cls.company.write({
                "vat": "83914571673",
                "email": "au_company@thrivebureau.com",
                "phone": "123456789",
                "zip": "2000",
