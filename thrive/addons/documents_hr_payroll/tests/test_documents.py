...
from thrive.addons.documents_hr.tests.test_documents_hr_common import TransactionCaseDocumentsHr
...
class TestCaseDocumentsBridgeHR(TestPayslipBase, TransactionCaseDocumentsHr):
    ...
    def test_payslip_document_creation(self):
        ...
        self.assertEqual(document.owner_id, self.env.ref('base.user_root'), "The owner_id should be thriveBot")
