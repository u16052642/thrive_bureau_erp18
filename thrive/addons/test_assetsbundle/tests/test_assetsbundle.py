...
from thrive.addons.base.models.assetsbundle import AssetsBundle, XMLAssetError, ANY_UNIQUE
...
class AddonManifestPatched(TransactionCase):
    def setUp(self):
        ...
        self.patch(thrive.modules.module, '_get_manifest_cached', Mock(side_effect=lambda module: self.manifests.get(module, {})))
...
class TestErrorManagement(HttpCase):
    ...
    def test_assets_bundle_css_error_backend(self):
        ...
        with mute_logger('thrive.addons.base.models.assetsbundle'):
            self.start_tour('/thrive', 'css_error_tour', login='admin')
