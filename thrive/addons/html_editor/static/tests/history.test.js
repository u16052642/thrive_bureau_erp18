...
import { click, pointerDown, pointerUp, press, queryOne } from "@thrive/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@thrive/hoot-mock";
...
describe("reset", () => {
    ...
    test.tags("desktop")("open table picker shouldn't add mutations", async () => {
        ...
        await click(".thrive-editor-editable p");
        await animationFrame();
