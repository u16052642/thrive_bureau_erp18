...
import { press } from "@thrive/hoot-dom";
...
describe("range not collapsed", () => {
    test("should copy a selection as text/plain, text/html and application/vnd.thrive.thrive-editor only text", async () => {
        ...
        expect(clipboardData.getData("application/vnd.thrive.thrive-editor")).toBe("<p>bcd</p>");
    });

    test("should copy a selection as text/plain, text/html and application/vnd.thrive.thrive-editor with a <br>", async () => {
        ...
        expect(clipboardData.getData("application/vnd.thrive.thrive-editor")).toBe("<p>abc<br>efg</p>");
    });

    test("should copy a selection as text/plain, text/html and application/vnd.thrive.thrive-editor in table", async () => {
        await setupEditor(
        ...
        expect(clipboardData.getData("application/vnd.thrive.thrive-editor")).toBe(
            "<table><tbody><tr><td><ul><li>a</li><li>b</li><li>c</li></ul></td><td><br></td></tr></tbody></table>"
        );
    });
    ...
    test("should copy the selection as a single list item (1)", async () => {
        ...
        expect(clipboardData.getData("application/vnd.thrive.thrive-editor")).toBe("First");
    });
    ...
    test("should copy the selection as a single list item (2)", async () => {
        ...
        expect(clipboardData.getData("application/vnd.thrive.thrive-editor")).toBe("List");
    });
