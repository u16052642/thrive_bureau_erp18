...
import { click, hover, queryAll, queryOne, waitFor, waitForNone } from "@thrive/hoot-dom";
...
test.tags("desktop")("Toolbar should not overflow scroll container", async () => {
    ...
    const editable = queryOne(".thrive-editor-editable");
...
test.tags("desktop")(
    ...
    async () => {
        ...
        const scrollableElement = queryOne(".o_content");
        const table = queryOne(".thrive-editor-editable table");
        await hover(".thrive-editor-editable td");
