...
import { click, manuallyDispatchProgrammaticEvent, press, waitFor } from "@thrive/hoot-dom";
 ...
 * @param {string} html
 */
export function pasteThriveEditorHtml(editor, html) {
    return pasteData(editor, html, "application/vnd.thrive.thrive-editor");
}
/**
 * @param {Node} node
 */
