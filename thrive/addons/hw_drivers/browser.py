...
class Browser:
    ...
    def close_browser(self):
        """close the browser"""
        # Kill browser instance (can't `instance.pkill()` as we can't keep the instance after Thrive service restarts)
        # We need to terminate it because Thrive will create a new instance each time it is restarted.
