...
import csv
import io
from thrive.tools import float_is_zero, SQL
...
class FecExportWizard(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # 1) the XSD file impose to have the label on the account.move, but Thrive has the label on the account.move.line,
        # so that's a  problem !
