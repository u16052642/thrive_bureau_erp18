...
class L10nHuEdiConnection:
    def __init__(self, env):
        ...
        :param env: the Thrive environment
        """
        self.env = env
    ...
    def do_token_exchange(self, credentials):
        ...
        try:
            # Convert into a naive UTC datetime, since Thrive can't store timezone-aware datetimes
    ...
    def _get_header_values(self, credentials, invoice_hashs=None):
        ...
        request_id = 'THRIVE' + secrets.token_hex(13)
        ...
        return {
            ...
            'softwareName': 'Thrive Enterprise',
            'softwareOperation': 'ONLINE_SERVICE',
            'softwareMainVersion': thrive_version,
            'softwareDevName': 'Thrive Bureau ERP',
            'softwareDevContact': 'andu@thrivebureau.com',
