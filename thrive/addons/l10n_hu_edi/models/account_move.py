...
from thrive.tools import formatLang, float_round, float_repr, cleanup_xml_node, groupby
from thrive.tools.misc import split_every
from thrive.addons.base_iban.models.res_partner_bank import normalize_iban
from thrive.addons.l10n_hu_edi.models.l10n_hu_edi_connection import format_bool, L10nHuEdiConnection, L10nHuEdiConnectionError
...
class AccountMove(models.Model):
    ...
    def _l10n_hu_edi_query_status_single_batch(self, connection):
        ...
        for processing_result in results['processing_results']:
            ...
            if not invoice:
                _logger.error(_('Could not match NAV transaction_code %(code)s, index %(index)s to an invoice in Thrive',
