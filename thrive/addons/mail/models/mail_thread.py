...
from thrive import _, api, exceptions, fields, models, Command
from thrive.addons.mail.tools.discuss import Store
from thrive.addons.mail.tools.web_push import push_to_end_point, DeviceUnreachableError
...
class MailThread(models.AbstractModel):
    ...
    def _detect_write_to_catchall(self, msg_dict):
        ...
        # (see thrive/thrive#161782), to clean when reaching master
