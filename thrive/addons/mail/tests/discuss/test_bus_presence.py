...
from thrive.addons.bus.tests.common import WebsocketCase
from thrive.addons.mail.tests.common import MailCommon
from thrive.addons.bus.models.bus import channel_with_db, json_dump
...
class TestBusPresence(WebsocketCase, MailCommon):
    def _receive_presence(self, sender, recipient):
        ...
        self.subscribe(
            websocket,
            [f"thrive-presence-{sender_bus_target._name}_{sender_bus_target.id}"],
