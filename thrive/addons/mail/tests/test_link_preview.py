...
class TestLinkPreview(MailCommon):
    ...
    def test_link_preview_ignore_internal_link(self):
        ...
        with patch.object(requests.Session, "get", self._patch_with_og_properties), patch.object(
            ...
            urls = [
                ("http://localhost:8069/", "http://localhost:8069/thrive", 0),
                ("http://localhost:8069/", "http://localhost:8069/thrive/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/web/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/", 1),
                ("http://localhost:8069/", "http://localhost:8069/thrive-experience", 1),
                ("https://www.thrivebureau.com/", "https://www.thrivebureau.com/web", 0),
                ("https://www.thrivebureau.com/", "https://www.thrivebureau.com/thrive", 0),
                ("https://www.thrivebureau.com/", "https://www.thrivebureau.com/thrive/", 0),
                ("https://www.thrivebureau.com/", "https://www.thrivebureau.com/thrive?debug=assets", 0),
                ("https://www.thrivebureau.com/", "https://www.thrivebureau.com/thrive#anchor", 0),
                ("https://www.thrivebureau.com/", "https://www.thrivebureau.com/thrive-experience", 1),
                ("https://www.thrivebureau.com/", "https://www.thrivebureau.com/thrive/1519/tasks/4102866", 0),
                ("http://www.thrivebureau.com/", "https://www.thrivebureau.com/thrive/1519/tasks/4102866", 1),
                ("https://clients.thrivebureau.com/", "https://www.thrivebureau.com/thrive/1519/tasks/4102866", 1),
                ("https://www.thrivebureau.com/", "https://wwwathrivebureau.com/thrive/", 1),
            ]
