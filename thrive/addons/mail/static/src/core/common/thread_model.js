...
export class Thread extends Record {
    ...
    isCorrespondentThriveBot = Record.attr(undefined, {
        compute() {
            return this.correspondent?.persona.eq(this.store.thrivebot);
        },
    });
    ...
    get allowCalls() {
        return (
            ...
            !this.correspondent?.persona.eq(this.store.thrivebot)
        );
    }
