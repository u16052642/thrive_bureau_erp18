/** @thrive-module alias=@web/../tests/utils default=false */

import { __debug__, after, afterEach, expect, getFixture } from "@thrive/hoot";
import { queryAll, queryFirst } from "@thrive/hoot-dom";
 ...
 *  element.
 * @property {HTMLElement|ThriveEnv} [target=getFixture()]
...
class Contains {
    ...
    constructor(selector, options = {}) {
        ...
        if (this.options.target?.testEnv) {
            // when ThriveEnv, special key `target`. See @start
