...
test("add_link utility function", () => {
    const testInputs = {
        ...
        "https://github.com/thrive/enterprise/compare/16.0...thrive-dev:enterprise:16.0-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/thrive/enterprise/compare/16.0...16.0-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/thrive/enterprise/compare/16.0...chỗgiặt-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/thrive/enterprise/compare/chỗgiặt...chỗgiặt-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/thrive/enterprise/compare/@...}-voip-fix_demo_data-tsm?expand=1": true,
    };
...
test("url with comma at the end", async () => {
    ...
    await insertText(".o-mail-Composer-input", messageBody);
    await click("button[aria-label='Send']:enabled");
    await contains(".o-mail-Message a:contains(https://thrivebureau.com)");
...
test("url with number in subdomain", async () => {
    ...
    await start();
    await openDiscuss(channelId);
    const messageBody = "https://www.45017478-master-all.runbot134.thrivebureau.com/thrive";
    await insertText(".o-mail-Composer-input", messageBody);
    await click("button[aria-label='Send']:enabled");
    await contains(
        ".o-mail-Message a:contains(https://www.45017478-master-all.runbot134.thrivebureau.com/thrive)"
    );
});
