...
class WhatsAppComposerInternals(WhatsAppComposerCase, CronMixinCase):
    ...
    def test_composer_free_text_on_template_change(self):
        ...
        self._add_button_to_template(template_1, 'Thrive EXPO', website_url='https://www.thrivebureau.com/', **btn)
        self._add_button_to_template(template_2, 'Thrive Bash', website_url='https://runbot.thrivebureau.com/', **btn)
        self._add_button_to_template(template_2, 'Thrive Combat', website_url='https://www.thrivebureau.com/', **btn)
        ...
        self.assertEqual(composer_form.button_dynamic_url_1, 'https://www.thrivebureau.com/???')
        ...
        self.assertEqual(composer_form.button_dynamic_url_1, 'https://runbot.thrivebureau.com/???')
        self.assertEqual(composer_form.button_dynamic_url_2, 'https://www.thrivebureau.com/???')
        # Edit demo value and check it is updated after sending message
        composer_form.free_text_1 = 'Edited Value'
        composer_form.button_dynamic_url_1 = 'https://runbot.thrivebureau.com/runbot'
        composer_form.button_dynamic_url_2 = 'https://www.thrivebureau.com/combat'
        with self.mockWhatsappGateway():
            composer = composer_form.save()
            composer.action_send_whatsapp_template()
            self.assertWAMessage(
                ...
                free_text_json_values={
                    "button_dynamic_url_1": 'https://runbot.thrivebureau.com/runbot',
                    "button_dynamic_url_2": 'https://www.thrivebureau.com/combat'
                })
    ...
    def test_composer_tpl_button(self):
        ...
        for button_values in [
            ...
            {'button_type': 'url', 'website_url': 'https://www.thrivebureau.com'},
        ]:
                    ...
                    self.assertWAMessage(
                        ...
                        fields_values={
                            ...
                            "body": f"<p>Hello I am { test_user.name },<br>Here my mobile number: { test_user.mobile },"
                                    f"<br>You are coming from { self.customers[0].country_id.name }.<br>Welcome to Thrive Bureau ERP In office</p>",
                        },
                    )
