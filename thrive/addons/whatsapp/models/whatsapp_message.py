...
from thrive.addons.whatsapp.tools import phone_validation as wa_phone_validation
from thrive.addons.whatsapp.tools.retryable_codes import WHATSAPP_RETRYABLE_ERROR_CODES
from thrive.addons.whatsapp.tools.bounced_codes import BOUNCED_ERROR_CODES
    ...
    def _post_message_in_active_channel(self):
        ...
        # diffrent user from any model: warn chat is about to be moved into a new conversation
            ...
            if self.mail_message_id.model and self.mail_message_id.res_id:
                ...
                url = f"{self.get_base_url()}/thrive/{self.mail_message_id.model}/{self.mail_message_id.res_id}"
