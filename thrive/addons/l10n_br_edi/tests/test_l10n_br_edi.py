...
from thrive.addons.l10n_br_edi.tests.data_invoice_1 import (
    invoice_1_request,
...
class TestL10nBREDI(TestL10nBREDICommon):
    ...
    def test_invoice_1_iap_errors(self):
        ...
        def wrap_iap(exception):
            ...
            with patch(
                "thrive.addons.l10n_br_avatax.models.account_external_tax_mixin.iap_jsonrpc", side_effect=exception
