...
class TestAccountReportsFilters(TestAccountReportsCommon, thrive.tests.HttpCase):
    ...
    def test_hide_line_at_0_tour(self):
        ...
        self.start_tour("/thrive", 'account_reports_hide_0_lines', login=self.env.user.login)
    ...
    def test_hide_line_at_0_tour_with_string_columns(self):
        ...
        self.start_tour("/thrive", 'account_reports_hide_0_lines_with_string_columns', login=self.env.user.login)
    ...
    def test_rounding_unit_tour(self):
        ...
        self.start_tour("/thrive", 'account_reports_rounding_unit', login=self.env.user.login)
