...
from thrive.addons.account.models.chart_template import SYSCOHADA_LIST
...
class TestBalanceSheetBalanced(TestAccountReportsCommon):
    ...
    def test_balance_sheet_balanced(self):
        ...
        installed_coas = [
            ...
            if template['visible'] and name not in ('syscohada', 'syscebnl')  # Syscohada template is visible but deprecated since thrive#163350
        ]
