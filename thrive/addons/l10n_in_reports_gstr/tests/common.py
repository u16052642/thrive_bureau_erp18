...
from thrive.addons.l10n_in.tests.common import L10nInTestInvoicingCommon
from thrive.addons.l10n_in_reports.tests.common import L10nInTestAccountReportsCommon
...
class L10nInTestAccountGstReportsCommon(L10nInTestAccountReportsCommon, L10nInTestInvoicingCommon):
    ...
    def _read_mock_json(self, filename):
        """
        Reads a JSON file using Thrive's file_open and returns the parsed data.
