...
from thrive.addons.l10n_in_reports_gstr.tests.common import L10nInTestAccountGstReportsCommon
...
class TestReports(L10nInTestAccountGstReportsCommon):
    ...
    def test_gstr2b(self):
        ...
        bill_not_in_thrive = self.env['account.move'].search([('ref', '=', '533515'), ('company_id', '=', self.default_company.id)])
