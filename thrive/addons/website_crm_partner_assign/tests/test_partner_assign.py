...
from thrive.addons.website_crm_partner_assign.controllers.main import (
    WebsiteAccount,
...
class TestPartnerLeadPortal(TestCrmCommon):
    ...
    @patch('thrive.http.GeoIP')
    def test_03_crm_partner_assign_geolocalization(self, GeoIpMock):
        """
            This test checks situation when "{ThriveURL}/partners" is visited from foreign country without resellers.
        ...
        """
        # Patch GeoIp so it acts, as if Thrive client is located in Mexico
