...
from thrive.addons.sale_timesheet_enterprise.tests.test_ranking import TestSaleTimesheetEnterpriseRanking
from thrive.addons.project_timesheet_holidays.tests.test_timesheet_holidays import TestTimesheetHolidays
