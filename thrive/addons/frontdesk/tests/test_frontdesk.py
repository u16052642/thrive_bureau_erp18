...
class TestFrontDesk(MailCommon):
    ...
    def assert_discuss_notification(self, user_name):
        channel = self.env['discuss.channel'].search_count(['&', ('name', 'ilike', 'ThriveBot'), ('name', 'ilike', user_name)])
    ...
    def test_host_notify_mail(self):
        ...
        with self.mock_mail_gateway():
            self.visitor_1.state = 'checked_in'
        self.assertSentEmail('"ThriveBot" <thrivebot@example.com>', self.partner_1)
