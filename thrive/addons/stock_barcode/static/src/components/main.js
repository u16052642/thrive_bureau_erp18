...
import { Component, EventBus, onPatched, onWillStart, onWillUnmount, useState, useSubEnv } from "@thrive/owl";
...
class MainComponent extends Component {
    ...
    playSound(ev) {
        ...
        this.sounds[type].play().catch((error) => {
            ...
            // issue for example), catch it to avoid Thrive's `UncaughtPromiseError`.
            console.log(error);
        });
    }
