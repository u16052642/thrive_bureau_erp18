...
from thrive.tests import tagged, loaded_demo_data
...
class TestInventoryAdjustmentBarcodeClientAction(TestBarcodeClientAction):
    ...
    def test_inventory_adjustment(self):
        ...
        - Validate
        """
        self.start_tour("/thrive/barcode", 'test_inventory_adjustment', login='admin', timeout=180)
    ...
    def test_inventory_adjustment_dont_update_location(self):
        ...
        self.start_tour("/thrive/barcode", 'test_inventory_adjustment_dont_update_location', login='admin', timeout=180)
    ...
    def test_inventory_adjustment_multi_company(self):
        ...
        self.start_tour("/thrive", 'test_inventory_adjustment_multi_company', login='admin', timeout=180)
    ...
    def test_inventory_adjustment_multi_location(self):
        ...
        self.start_tour("/thrive/barcode", 'test_inventory_adjustment_multi_location', login='admin', timeout=180)
    ...
    def test_inventory_adjustment_tracked_product(self):
        ...
        self.start_tour("/thrive/barcode", 'test_inventory_adjustment_tracked_product', login='admin', timeout=180)
    ...
    def test_inventory_adjustment_tracked_product_multilocation(self):
        ...
        self.start_tour("/thrive/barcode", "test_inventory_adjustment_tracked_product_multilocation", login="admin", timeout=180)
    ...
    def test_inventory_adjustment_tracked_product_permissive_quants(self):
        ...
        self.start_tour("/thrive/barcode", 'test_inventory_adjustment_tracked_product_permissive_quants', login='admin', timeout=180)
    ...
    def test_inventory_create_quant(self):
        ...
        self.start_tour("/thrive/barcode", 'test_inventory_create_quant', login='admin', timeout=180)
    ...
    def test_inventory_dialog_not_counted_serial_numbers(self):
        ...
        self.start_tour("/thrive/barcode?debug=assets", 'test_inventory_dialog_not_counted_serial_numbers', login='admin')
        self.assertRecordValues(quants, [
    ...
    def test_inventory_image_visible_for_quant(self):
        ...
        wizard_request_count.action_request_count()
        self.start_tour("/thrive/barcode/", 'test_inventory_image_visible_for_quant', login='admin', timeout=180)
    ...
    def test_inventory_nomenclature(self):
        ...
        self.start_tour("/thrive/barcode", 'test_inventory_nomenclature', login='admin', timeout=180)
    ...
    def test_inventory_package(self):
        ...
        self.start_tour("/thrive/barcode", "test_inventory_package", login="admin", timeout=180)
    ...
    def test_inventory_packaging(self):
        ...
        self.start_tour("/thrive/barcode", 'test_inventory_packaging', login='admin', timeout=180)
    ...
    def test_inventory_serial_product_packaging(self):
        ...
        self.start_tour('/thrive/barcode', 'test_inventory_serial_product_packaging', login='admin', timeout=180)
    ...
    def test_inventory_owner_scan_package(self):
        ...
        self.start_tour("/thrive/barcode", 'test_inventory_owner_scan_package', login='admin', timeout=180)
    ...
    def test_inventory_setting_count_entire_locations_on(self):
        ...
        self.start_tour("/thrive/barcode", 'test_inventory_setting_count_entire_locations_on', login='admin', timeout=180)
    ...
    def test_inventory_setting_count_entire_locations_off(self):
        ...
        wizard_request_count.action_request_count()
        self.start_tour('/thrive/barcode', 'test_inventory_setting_count_entire_locations_off', login='admin', timeout=180)
    ...
    def test_inventory_setting_show_quantity_to_count(self):
        ...
        self.start_tour("/thrive/barcode", 'test_inventory_setting_show_quantity_to_count_on', login='admin', timeout=180)
        ...
        self.start_tour("/thrive/barcode", 'test_inventory_setting_show_quantity_to_count_off', login='admin', timeout=180)
    ...
    def test_inventory_using_buttons(self):
        ...
        self.start_tour("/thrive/barcode", 'test_inventory_using_buttons', login='admin', timeout=180)
    ...
    def test_gs1_inventory_gtin_8(self):
        ...
        self.start_tour("/thrive/barcode", 'test_gs1_inventory_gtin_8', login='admin', timeout=180)
    ...
    def test_gs1_inventory_product_units(self):
        ...
        self.start_tour("/thrive/barcode", 'test_gs1_inventory_product_units', login='admin', timeout=180)
    ...
    def test_gs1_inventory_package(self):
        ...
        self.start_tour("/thrive/barcode", 'test_gs1_inventory_package', login='admin', timeout=180)
    ...
    def test_gs1_inventory_lot_serial(self):
        ...
        self.start_tour("/thrive/barcode", 'test_gs1_inventory_lot_serial', login='admin', timeout=180)
    ...
    def test_scan_product_lot_with_package(self):
        ...
        self.start_tour("/thrive", 'stock_barcode_package_with_lot', login="admin")
