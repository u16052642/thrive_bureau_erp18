...
class TestPickingBarcodeClientAction(TestBarcodeClientAction):
    ...
    def test_picking_scan_package_confirmation(self):
        ...
        url = f'/thrive/{delivery_with_move.id}/action-stock_barcode.stock_barcode_picking_client_action'
    ...
    def test_internal_picking_from_scratch_with_package(self):
        ...
        self.start_tour("/thrive/barcode", 'test_internal_picking_from_scratch_with_package', login='admin', timeout=1800000)
    ...
    def test_receipt_reserved_2_partial_put_in_pack(self):
        ...
        self.start_tour("/thrive/barcode", "test_receipt_reserved_2_partial_put_in_pack", login="admin", timeout=180)
    ...
    def test_delivery_source_location(self):
        ...
        url = '/thrive/action-stock_barcode.stock_barcode_action_main_menu'
    ...
    def test_pack_multiple_scan(self):
        ...
        self.start_tour("/thrive/barcode", 'test_pack_multiple_scan', login='admin', timeout=180)
    ...
    def test_pack_common_content_scan(self):
        ...
        self.start_tour("/thrive/barcode", 'test_pack_common_content_scan', login='admin', timeout=180)
    ...
    def test_pack_multiple_location(self):
        ...
        self.start_tour("/thrive/barcode", 'test_pack_multiple_location', login='admin', timeout=180)
    ...
    def test_reload_flow(self):
        ...
        self.start_tour("/thrive/barcode", 'test_reload_flow', login='admin', timeout=180)
    ...
    def test_duplicate_serial_number(self):
        ...
        self.start_tour("/thrive/barcode", 'test_receipt_duplicate_serial_number', login='admin', timeout=180)
        self.start_tour("/thrive/barcode", 'test_delivery_duplicate_serial_number', login='admin', timeout=180)
    ...
    def test_picking_owner_scan_package(self):
        ...
        self.start_tour("/thrive/barcode", 'test_picking_owner_scan_package', login='admin', timeout=180)
    ...
    def test_scrap(self):
        ...
        # Opens the barcode main menu to be able to open the pickings by scanning their name.
        self.start_tour("/thrive/barcode", "test_scrap", login="admin", timeout=180)
    ...
    def test_show_entire_package(self):
        ...
        self.start_tour('/thrive/barcode', 'test_show_entire_package', login='admin', timeout=180)
    ...
    def test_setting_barcode_allow_extra_product(self):
        ...
        delivery.action_confirm()
        delivery.action_assign()
        self.start_tour("/thrive/barcode", 'test_setting_barcode_allow_extra_product', login='admin', timeout=180)
    ...
    def test_split_line_on_destination_scan(self):
        ...
        self.start_tour('/thrive/barcode', 'test_split_line_on_destination_scan', login='admin')
    ...
    def test_split_line_on_exit_for_delivery(self):
        ...
        self.start_tour("/thrive/barcode", 'test_split_line_on_exit_for_delivery', login='admin')
    ...
    def test_split_line_on_exit_for_receipt(self):
        ...
        self.start_tour("thrive/barcode/", 'test_split_line_on_exit_for_receipt', login='admin')
    ...
    def test_multi_company_record_access_in_barcode(self):
        ...
        url = f'/thrive/action-stock_barcode.stock_barcode_action_main_menu?cids={cids}'
    ...
    def test_gs1_delivery_ambiguous_lot_number(self):
        ...
        # Run the tour.
        self.start_tour('/thrive/barcode', 'test_gs1_delivery_ambiguous_lot_number', login='admin', timeout=180)
    ...
    def test_gs1_receipt_conflicting_barcodes_mistaken_as_gs1(self):
        ...
        self.start_tour("/thrive/barcode", 'test_gs1_receipt_conflicting_barcodes_mistaken_as_gs1', login='admin', timeout=180)
    ...
    def test_gs1_receipt_scan_not_gs1_multi_barcode(self):
        ...
        self.env.user.write({'groups_id': [(4, grp_lot.id, 0)]})
        self.env.company.nomenclature_id = self.env.ref('barcodes_gs1_nomenclature.default_gs1_nomenclature')
        self.start_tour('/thrive/barcode', 'test_gs1_receipt_scan_not_gs1_multi_barcode', login='admin')
    ...
    def test_gs1_package_receipt_and_delivery(self):
        ...
        self.start_tour("/thrive/barcode", 'test_gs1_package_receipt', login='admin', timeout=180)
        ...
        self.start_tour("/thrive/barcode", 'test_gs1_package_delivery', login='admin', timeout=180)
    ...
    def test_gs1_receipt_packaging_with_uom(self):
        ...
        self.start_tour('/thrive/barcode', 'test_gs1_receipt_packaging_with_uom', login='admin', timeout=180)
    ...
    def test_gs1_tracked_packaging(self):
        ...
        self.start_tour("/thrive/barcode", 'test_gs1_tracked_packaging', login='admin', timeout=180)
    ...
    def test_serial_product_packaging(self):
        ...
        self.start_tour('/thrive/barcode', 'test_serial_product_packaging', login='admin', timeout=180)
    ...
    def test_barcode_signature_flow(self):
        ...
        url = '/thrive/action-stock_barcode.stock_picking_type_action_kanban'
