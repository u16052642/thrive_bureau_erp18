...
from thrive.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
from thrive.tests.common import HttpCase, JsonRpcException
...
class TestSmsController(HttpCase, TestSMSActionsCommon):
    ...
    @mute_logger("thrive.addons.base.models.ir_http")
    ...
    @mute_logger('thrive.addons.base.models.ir_http', 'thrive.addons.sms.controllers.main', 'thrive.http')
