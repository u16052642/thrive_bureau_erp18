...
import { CLIPBOARD_WHITELISTS, setSelection } from "../../src/ThriveEditor.js";
        ...
        it('should copy a selection as text/plain, text/html and text/thrive-editor', async () => {
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/thrive-editor')).to.be.equal('<p>bcd</p>');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/thrive-editor')).to.be.equal('<p>abc<br>efg</p>');
                },
            });
            await testEditor(BasicEditor, {
        ...
        it('should wrap the selected text with clones of ancestors up to a block element to keep styles', async () => {
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/thrive-editor')).to.be.equal('<p><span style="font-size: 16px;">Test</span> <span style="font-size: 48px;"><font style="color: rgb(255, 0, 0);">Test</font></span></p>');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/thrive-editor')).to.be.equal('<p><strong><em><u><font class="text-o-color-1">there</font></u></em></strong></p>');
                },
            });
        });
        it('should copy the selection as a single list item', async () => {
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/thrive-editor')).to.be.equal('First');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/thrive-editor')).to.be.equal('List');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/thrive-editor')).to.be.equal('<span style="font-size: 48px;"><font style="color: rgb(255, 0, 0);">First</font></span>');
                },
            });
        })
        it('should copy the selection as a list with multiple list items', async () => {
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/thrive-editor')).to.be.equal('<ul><li>First</li><li>Second</li></ul>');
                },
            });
        });
    });
...
describe('Paste', () => {
    ...
    describe('Special cases', () => {
        describe('lists', async () => {
            ...
            it('should paste a deeply nested list copied outside from thrive', async () => {
                await testEditor(BasicEditor, {
                    contentBefore: '<ul><li>[]<br></li></ul>',
                    stepFunction:  async editor => {
                        await pasteHtml(editor, unformat(`
        ...
        describe('range collapsed', async () => {
            ...
            it('should paste html content over an empty link', async () => {
                await testEditor(BasicEditor, {
                    ...
                    contentAfter: '<p><a href="www.thrivebureau.com">thrivebureau.com</a></p><p><a href="www.google.com">google.com</a>[]</p>',
                });
            });
    ...
    describe('editable in iframe', () => {
        it('should paste thrive-editor html', async () => {
            // Setup
            ...
            const clipboardData = new DataTransfer();
            clipboardData.setData('text/thrive-editor', '<p>text<b>bold text</b>more text</p>');
