...
from thrive.tools.image import is_image_size_above
    ...
    def action_open_documents(self):
        ...
        return {
            ...
            'help': """
                ...
                <p>
                    <a class="oe_link" href="https://www.thrivebureau.com/documentation/17.0/_downloads/5f0840ed187116c425fdac2ab4b592e1/pdfquotebuilderexamples.zip">
                    %s
                    </a>
                </p>
            """ % (
