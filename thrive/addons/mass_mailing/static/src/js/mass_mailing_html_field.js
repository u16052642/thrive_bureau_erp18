...
import { onWillUnmount, onWillStart, reactive, status, useSubEnv } from "@thrive/owl";
    ...
    async _onSnippetsLoaded() {
        ...
        $themeSelectorNew.on('click', '.dropdown-item', async (e) => {
            ...
            setTimeout(() => {
                ...
                this.wysiwyg.thriveEditor.dispatchEvent(new Event('historyStep'));
        ...
        if (editableAreaIsEmpty) {
            ...
            // We actually hide the ThriveEditor toolbar by calling
        ...
        this.wysiwyg.thriveEditor.activateContenteditable();
    }
    _getCodeViewEl() {
