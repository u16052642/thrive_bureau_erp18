...
from thrive.addons.l10n_mx_edi.models.l10n_mx_edi_document import CANCELLATION_REASON_SELECTION, CFDI_DATE_FORMAT
...
class Picking(models.Model):
    ...
    def _l10n_mx_edi_cfdi_post_cancel(self):
        ...
        - The user can cancel the picking from the SAT, then update the SAT state in Thrive.
        """
        self.ensure_one()
