...
from thrive.tools import mute_logger, misc
    ...
    def test_invoice_multicurrency(self):
        '''Tests if we generate an accepted XML for an invoice in non-company currency
           ...
           For example:
              ...
              * tax rate: 15 %
                tag: IMP_6
              * thrive base amount in document currency: 226.98
              * thrive tax  amount in document currency: 34.05 = round(0.15 * 226.98, 2)
              * "effective tax rate": 15.00132170235263 %
              * thrive base amount in company  currency: 889559.49
                tag: IMP_2
              * thrive tax  amount in company  currency: 133445.68 = round(34.05 * 3919.109578, 2)
                tag: IMP_4
