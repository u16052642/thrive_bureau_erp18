...
import { Model, stores } from "@thrive/o-spreadsheet";
...
export class VersionHistoryAction extends Component {
    ...
    async fetchData() {
        ...
        this.currentRevisionId =
            ...
            "START_REVISION";
        this.thriveDataProvider = new ThriveDataProvider(this.env);
    }
    ...
    createModel() {
        this.thriveDataProvider.addEventListener(
            "data-source-updated",
        ...
        this.model = new Model(
            data,
            {
                custom: {
                    env: this.env,
                    orm: this.orm,
                    thriveDataProvider: this.thriveDataProvider,
                },
                external: {
