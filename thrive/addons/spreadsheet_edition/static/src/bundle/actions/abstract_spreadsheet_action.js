...
export class AbstractSpreadsheetAction extends Component {
    ...
    getModelConfig() {
        ...
        const thriveDataProvider = new ThriveDataProvider(this.env);
        thriveDataProvider.addEventListener("data-source-updated", () => {
            this.model.dispatch("EVALUATE_CELLS");
        });
        return {
            custom: { env: this.env, orm: this.orm, thriveDataProvider },
            external: {
