...
import { UIPlugin, tokenize, helpers } from "@thrive/o-spreadsheet";
...
/**
 * @typedef {import("@thrive/o-spreadsheet").SpreadsheetPivotTable} SpreadsheetPivotTable
 * @typedef {import("@spreadsheet").ThrivePivotDefinition} ThrivePivotDefinition
 * @typedef {import("@spreadsheet/pivot/thrive_pivot").ThrivePivot} ThrivePivot
 * @typedef {import("@spreadsheet/pivot/thrive_pivot").PivotDomain} PivotDomain
 */
...
export class PivotAutofillPlugin extends UIPlugin {
     ...
     * @param {ThrivePivot} dataSource
     * @param {ThrivePivotDefinition} definition
     *
     * @private
     *
     * @returns {string}
