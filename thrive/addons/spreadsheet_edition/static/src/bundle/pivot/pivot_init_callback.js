 ...
 *
 * @param {import("@thrive/o-spreadsheet").DispatchResult} result
 */
...
export function insertPivot(pivotData) {
    ...
    /** @type {import("@spreadsheet").ThrivePivotCoreDefinition} */
    ...
    /**
     * @param {import("@spreadsheet").ThriveSpreadsheetModel} model
     */
