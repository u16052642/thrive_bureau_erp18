...
import { components, helpers, stores, hooks } from "@thrive/o-spreadsheet";
import { Component, onWillStart, onWillUpdateProps } from "@thrive/owl";
import { ThrivePivotLayoutConfigurator } from "./thrive_pivot_layout_configurator/thrive_pivot_layout_configurator";
...
export class PivotDetailsSidePanel extends Component {
    ...
    /** @returns {import("@spreadsheet/pivot/thrive_pivot").default} */
    get pivot() {
