...
import { hooks, components } from "@thrive/o-spreadsheet";
...
export class ListDetailsSidePanel extends Component {
    ...
    onDomainUpdate(domain) {
        ...
        this.env.model.dispatch("UPDATE_THRIVE_LIST", {
            listId: this.props.listId,
            list: {
                ...listDefinition,
                searchParams: {
    ...
    duplicateList() {
        ...
        const result = this.env.model.dispatch("DUPLICATE_THRIVE_LIST", {
            listId: this.props.listId,
            newListId,
        });
    ...
    deleteList() {
        this.env.askConfirmation(_t("Are you sure you want to delete this list?"), () => {
            this.env.model.dispatch("REMOVE_THRIVE_LIST", { listId: this.props.listId });
