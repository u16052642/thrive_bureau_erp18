import { components, constants } from "@thrive/o-spreadsheet";
import { _t } from "@web/core/l10n/translation";

const { ChartWithAxisDesignPanel } = components;
const { CHART_AXIS_CHOICES } = constants;

export class ThriveChartWithAxisDesignPanel extends ChartWithAxisDesignPanel {
    static template = "spreadsheet_edition.ThriveChartWithAxisDesignPanel";
