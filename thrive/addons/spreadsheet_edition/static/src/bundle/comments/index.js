...
import { coreTypes, registries, stores, addRenderingLayer } from "@thrive/o-spreadsheet";
...
corePluginRegistry.add("thriveCellThreadsPlugin", CellThreadsPlugin);
...
cellPopoverRegistry.add("ThriveCellComment", {
...
const INSERT_COMMENT_ACTION = {
    ...
    execute: async (env) => {
        ...
        env.getStore(CellPopoverStore).open({ col, row }, "ThriveCellComment");
    },
