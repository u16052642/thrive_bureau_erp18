...
from thrive.addons.delivery_shiprocket.models.shiprocket_request import ShipRocket
...
class TestDeliveryShiprocket(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.in_partner = cls.env["res.partner"].create({
            ...
            'zip': 382418,
            'phone': '+91 9227411196',
            'email': 'partner@thrivebureau.com'
        })
    ...
    def _get_expected_parcel_data(self):
        ...
        return {
            ...
            'billing_email': 'partner@thrivebureau.com',
            ...
            'shipping_email': 'partner@thrivebureau.com',
