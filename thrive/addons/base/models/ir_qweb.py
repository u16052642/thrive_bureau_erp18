...
<https://www.thrivebureau.com/documentation/master/developer/reference/frontend/qweb.html>`
...
The generated code uses ``has_group`` Thrive method from ``res.users`` model.
