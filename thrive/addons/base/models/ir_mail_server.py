...
from thrive import api, fields, models, tools, _, modules
from thrive.exceptions import UserError
from thrive.tools import formataddr, email_normalize, encapsulate_email, email_domain_extract, email_domain_normalize, human_size
...
class IrMailServer(models.Model):
    ...
    def _find_mail_server(self, email_from, mail_servers=None):
        ...
        # Skip if passed email_from is False (example Thrivebot has no email address)
        if email_from:
