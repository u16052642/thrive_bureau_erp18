...
class IrAsset(models.Model):
    ...
    def _fill_asset_paths(self, bundle, asset_paths, seen, addons, installed, **assets_params):
        ...
        for addon in addons:
            for command in thrive.modules.module._get_manifest_cached(addon)['assets'].get(bundle, ()):
    ...
    def _topological_sort(self, addons_tuple):
        ...
        def mapper(addon):
            manif = thrive.modules.module._get_manifest_cached(addon)
    ...
    def _get_paths(self, path_def, installed):
        ...
        addon = path_parts[0]
        addon_manifest = thrive.modules.module._get_manifest_cached(addon)
