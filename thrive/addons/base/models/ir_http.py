...
from thrive.http import request, Response, ROUTING_KEYS
from thrive.modules.registry import Registry
from thrive.service import security
from thrive.tools.json import json_default
from thrive.tools.misc import get_lang, submap
from thrive.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and thrive.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _gc_sessions(self):
        if os.getenv("THRIVE_SKIP_GC_SESSIONS"):
            return
