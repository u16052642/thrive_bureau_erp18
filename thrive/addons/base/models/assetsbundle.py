...
from thrive.tools import (func, misc, transpile_javascript,
    is_thrive_module, SourceMapGenerator, profiler, OrderedSet)
            ...
            if self.templates:
                ...
                template_bundle = textwrap.dedent(f"""
                    ...
                    *******************************************/
                    ...
                    thrive.define("{self.name}.bundle.xml", ["@web/core/templates"], function(require) {{
                        "use strict";
...
class JavascriptAsset(WebAsset):
    ...
    def is_transpiled(self):
        if self._is_transpiled is None:
            self._is_transpiled = bool(is_thrive_module(self.url, super().content))
