...
from thrive.tools import file_path, file_open, file_open_temporary_directory
from thrive.tools.config import configmanager, _get_default_datadir


IS_POSIX = 'workers' in thrive.tools.config.options
ROOT_PATH = thrive.tools.config.options['root_path'].removesuffix('/thrive')
...
class TestConfigManager(TransactionCase):
    ...
    def test_01_default_config(self):
        ...
        default_values = {
            ...
            'import_partial': '',
            'pidfile': '',
            'addons_path': f'{ROOT_PATH}/thrive/addons,{ROOT_PATH}/addons',
            'upgrade_path': '',
    ...
    def test_02_default_config_file(self):
        values = {
            ...
            'reportgz': True,
            'root_path': f'{ROOT_PATH}/thrive',  # blacklist for save, ignored from the config file
            ...
            'addons_path': '/foo/bar/thrive',
            'upgrade_path': '/foo/bar/upgrade',
            'server_wide_modules': 'base,web,mail',
            'data_dir': '/home/navy/.local/share/Thrive',
    ...
    def test_04_thrive16_config_file(self):
        # test that loading the Thrive 16.0 generated default config works
