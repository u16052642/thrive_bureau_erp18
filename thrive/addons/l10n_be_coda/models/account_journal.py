...
from thrive import models, fields, tools
            ...
            if not line:
                ...
                if line[1] == '1':
                    ...
                    if statement['lines'][-1]['ref'][0:4] != line[2:6]:
                        raise UserError(_(
                            "Error %(error_code)s: CODA parsing error on movement data record 2.2, seq nr %(seq_nr)s! Please report this issue via your Thrive support channel.",
                            error_code="R2004",
                            seq_nr=line[2:10],
                        ))
                    ...
                    if statement['lines'][-1]['ref'][0:4] != line[2:6]:
                        raise UserError(_(
                            "Error %(error_code)s: CODA parsing error on movement data record 2.3, seq nr %(seq_nr)s! Please report this issue via your Thrive support channel.",
                            error_code="R2005",
                            seq_nr=line[2:10],
                        ))
                    if statement['version'] == '1':
                ...
                if line[1] == '1':
                    ...
                    if infoLine['ref'] != rmspaces(line[2:10]):
                        raise UserError(_(
                            "Error %(error_code)s: CODA parsing error on information data record 3.2, seq nr %(seq_nr)s! Please report this issue via your Thrive support channel.",
                            error_code="R3004",
                            seq_nr=line[2:10],
                        ))
                    ...
                    if infoLine['ref'] != rmspaces(line[2:10]):
                        raise UserError(_(
                            "Error %(error_code)s: CODA parsing error on information data record 3.3, seq nr %(seq_nr)s! Please report this issue via your Thrive support channel.",
                            error_code="R3005",
                            seq_nr=line[2:10],
                        ))
