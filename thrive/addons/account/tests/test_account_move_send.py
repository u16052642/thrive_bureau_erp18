...
from thrive.tests import users, warmup, tagged
...
class TestAccountMoveSend(TestAccountMoveSendCommon):
    ...
    def test_invoice_web_service_after_pdf_rendering(self):
        ...
        with patch(
                'thrive.addons.account.models.account_move_send.AccountMoveSend._call_web_service_after_invoice_pdf_render',
    ...
    def test_proforma_pdf(self):
        ...
        # Process.
        with patch(
                'thrive.addons.account.models.account_move_send.AccountMoveSend._hook_invoice_document_before_pdf_report_render',
    ...
    def test_link_pdf_webservice_fails_before(self):
        ...
        # Process.
        with patch(
                'thrive.addons.account.models.account_move_send.AccountMoveSend._call_web_service_before_invoice_pdf_render',
    ...
    def test_cron_notifications(self):
        ...
        sp_partner_2 = self.env['res.partner'].create({'name': 'Partner 2', 'email': 'test@test.thrivebureau.com'})
