...
from thrive.addons.hr_payroll_account_iso20022.tests.test_payroll_sepa import TestPayrollSEPACreditTransferCommon
from thrive.tests.common import test_xsd
