...
from thrive.tests.common import HttpCase, tagged, freeze_time
...
class TestTourBoM(HttpCase):
    def test_mrp_bom_product_catalog(self):
        ...
        url = f'/thrive/action-mrp.mrp_bom_form_action/{bom.id}'
    ...
    def test_manufacture_from_bom(self):
        ...
        """
        url = '/thrive/action-mrp.mrp_bom_form_action'
