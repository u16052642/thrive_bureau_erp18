...
class TestMRPBarcodeClientAction(TestBarcodeClientAction):
    ...
    def test_barcode_production_reserved_from_multiple_locations(self):
        ...
        url = f'/thrive/{mo.id}/action-stock_barcode_mrp.stock_barcode_mo_client_action?debug=assets'
    ...
    def test_barcode_production_components_reservation_state(self):
        ...
        mo.action_confirm()
        url = f"/thrive/{mo.id}/action-stock_barcode_mrp.stock_barcode_mo_client_action"
    ...
    def test_split_line_on_exit_for_production(self):
        ...
        self.start_tour("thrive/barcode/", 'test_split_line_on_exit_for_production', login='admin')
