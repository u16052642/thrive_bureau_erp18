...
from thrive.addons.l10n_es_edi_tbai.tests.common import TestEsEdiTbaiCommonGipuzkoa
...
class TestPosEdi(TestEsEdiTbaiCommonGipuzkoa, TestPointOfSaleCommon):
    ...
    def pay_pos_order(cls, pos_order):
        ...
        with patch(
            'thrive.addons.l10n_es_edi_tbai.models.l10n_es_edi_tbai_document.requests.Session.request',
