...
class TestCoDianCommon(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.document_path = 'thrive.addons.l10n_co_dian.models.l10n_co_dian_document.L10nCoDianDocument'
        cls.utils_path = 'thrive.addons.l10n_co_dian.xml_utils'
