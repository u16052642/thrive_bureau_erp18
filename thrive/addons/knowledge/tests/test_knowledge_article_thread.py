...
from thrive.addons.knowledge.tests.test_knowledge_article_business import KnowledgeCommonBusinessCase
...
class TestKnowledgeArticleTours(HttpCaseWithUserDemo):
    ...
    def test_knowledge_article_comments(self):
        self.start_tour('/thrive', 'knowledge_article_comments', login='demo')
