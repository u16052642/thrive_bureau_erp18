...
class TestKnowledgeEditorCommands(HttpCaseWithUserDemo):
    ...
    def test_knowledge_article_commands_tour(self):
        ...
        self.start_tour('/thrive', 'knowledge_article_commands_tour', login='admin')
        ...
        self.start_tour('/thrive', 'knowledge_article_commands_readonly_tour', login='demo')

    def test_knowledge_calendar_command_tour(self):
        """Test the /calendar command in the editor"""
        self.start_tour('/thrive', 'knowledge_calendar_command_tour', login='admin')
