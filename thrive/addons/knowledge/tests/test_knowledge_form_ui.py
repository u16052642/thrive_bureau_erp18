...
class TestKnowledgeUI(TestKnowledgeUICommon):
    ...
    def test_knowledge_history(self):
        ...
        self.start_tour('/thrive', 'knowledge_history_tour', login='demo')
    ...
    def test_knowledge_load_template(self):
        ...
        self.start_tour('/thrive', 'knowledge_load_template', login='admin')
    ...
    def test_knowledge_main_flow(self):
        ...
        with self.mock_mail_gateway(), self.mock_mail_app():
            self.start_tour('/thrive', 'knowledge_main_flow_tour', login='admin')
    ...
    def test_knowledge_pick_emoji(self):
        ...
        self.start_tour('/thrive', 'knowledge_pick_emoji_tour', login='admin')
    ...
    def test_knowledge_cover_selector(self):
        ...
        self.start_tour('/thrive', 'knowledge_cover_selector_tour', login='admin')
    ...
    def test_knowledge_properties_tour(self):
        ...
        self.start_tour('/thrive', 'knowledge_properties_tour', login='admin')
    ...
    def test_knowledge_items_search_favorites_tour(self):
        ...
        self.start_tour('/thrive', 'knowledge_items_search_favorites_tour', login='admin')

    def test_knowledge_search_favorites_tour(self):
        """Test search favorites with searchModel state"""
        self.env['knowledge.article'].create([{'name': 'Article 1', 'is_article_visible_by_everyone': True}])
        self.start_tour('/thrive', 'knowledge_search_favorites_tour', login='admin')

    @users('admin')
    def test_knowledge_sidebar(self):
        # This tour checks that the features of the sidebar work as expected
        self.start_tour('/thrive', 'knowledge_sidebar_tour', login='admin', timeout=100)
        ...
        self.start_tour('/thrive', 'knowledge_sidebar_readonly_tour', login='demo')
...
class TestKnowledgeUIWithUnsplash(TestKnowledgeUICommon):
    ...
    def test_knowledge_cover_selector_unsplash(self):
        ...
        are set.
        """
        self.start_tour('/thrive', 'knowledge_random_cover_tour', login='demo')
