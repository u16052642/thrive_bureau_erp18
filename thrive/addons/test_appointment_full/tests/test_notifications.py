...
from thrive.addons.google_calendar.models.res_users import User as GoogleUser
from thrive.addons.google_calendar.tests.test_sync_common import TestSyncGoogle
from thrive.addons.microsoft_calendar.models.res_users import User as MsftUser
from thrive.addons.microsoft_calendar.tests.common import TestCommon as MsftTestCommon
...
class TestSyncThrive2GoogleMail(TestSyncGoogle, TestAppointmentNotificationCommon):
    @freeze_time('2020-02-01 09:00:00')
