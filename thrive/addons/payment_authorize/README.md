...
- `16.0`
  - Archiving a token no longer deactivates the related payment method on Authorize. thrive/thrive#93774
- `15.4`
  - The support for full refunds is added. thrive/thrive#92279
- `15.0`
  - Support for ACH payments is added. thrive/thrive#75289
- `14.3`
  - The payment with redirection flow that existed alongside the direct payment flow is dropped.
    thrive/thrive#141661
