...
class DiscussChannel(WhatsAppFullCase, MockIncomingWhatsApp):
    ...
    def test_channel_info_link(self):
        ...
        for reply_template, reply_user, expected_body, error_msg in [
            (
                ...
                f'href="{test_record.get_base_url()}/thrive/{test_record._name}/{test_record.id}">'
            ...
            with self.subTest(reply_template=template, reply_user=reply_user):
                ...
                self.assertIn(
                    first_info.body,
                    f'<p>Related WhatsApp Base Test: <a target="_blank" href="{test_record.get_base_url()}/thrive/'
    ...
    def test_channel_info_link_noname(self):
        ...
        self.assertIn(
            ...
            f' href="{test_record_noname.get_base_url()}/thrive/{test_record_noname._name}/{test_record_noname.id}">'
