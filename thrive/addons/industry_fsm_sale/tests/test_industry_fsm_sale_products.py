...
class TestFsmSaleProducts(HttpCase, TestFsmFlowCommon):
    ...
    def test_industry_fsm_sale_products_tour(self):
        self.start_tour("/thrive", 'industry_fsm_sale_products_tour', login="admin")

    def test_industry_fsm_sale_quantity_products_tour(self):
        self.start_tour("/thrive", 'industry_fsm_sale_quantity_products_tour', login="admin")
    ...
    def test_industry_fsm_sale_products_from_fsm_tour(self):
        ...
        self.start_tour("/thrive", 'industry_fsm_sale_products_compute_catalog_tour', login="admin")
