...
from thrive.addons.base.models.ir_qweb_fields import Markup
from thrive.tools.float_utils import json_float_round, float_compare
...
class AccountMove(models.Model):
    ...
    def _l10n_ke_oscu_import_invoice(self, invoice, data, is_new):
        """ Decodes the json content from eTIMS into an Thrive move.
