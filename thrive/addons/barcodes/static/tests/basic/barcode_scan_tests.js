...
import { xml, Component } from "@thrive/owl";
...
QUnit.test("Display notification for media device permission on barcode scanning", async () => {
    ...
    await contains(".modal-body", { text: "Unable to access cameraCould not start scanning. Thrive needs your authorization first." });
