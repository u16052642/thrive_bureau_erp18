...
from thrive.addons.hw_drivers.iot_handlers.lib.ctypes_terminal_driver import CtypesTerminalDriver, import_ctypes_library, CTYPES_BUFFER_SIZE, create_ctypes_string_buffer
...
# Load library
LIB_NAME = 'libsix_thrive_w.dll' if system() == 'Windows' else 'libsix_thrive_l.so'
