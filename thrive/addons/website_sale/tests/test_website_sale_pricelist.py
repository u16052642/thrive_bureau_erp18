...
from thrive.addons.base.tests.common import HttpCaseWithUserPortal, TransactionCaseWithUserDemo
...
class TestWebsitePriceListAvailableGeoIP(TestWebsitePriceListAvailable):
    ...
    def test_get_pricelist_available_geoip5(self):
        ...
        with patch('thrive.addons.website_sale.models.website.Website._get_geoip_country_code', return_value=self.US.code):
