...
from thrive.tests import HttpCase, tagged, loaded_demo_data
...
class TestSnippets(HttpCase):
    ...
    def test_02_snippet_products_remove(self):
        ...
        self.assertEqual(website_visitor.name, user.name, "The visitor should be linked to the admin user, not ThriveBot or anything.")
