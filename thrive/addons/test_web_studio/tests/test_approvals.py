...
from thrive.tests.common import TransactionCase, HttpCase, tagged
from thrive.addons.web_studio.tests.test_ui import setup_view_editor_data
...
class TestStudioApprovalsUIUnit(HttpCase):
    ...
    def test_disable_approvals(self):
        ...
        url = f"/thrive/action-studio?mode=editor&_action={self.testAction.id}&_view_type=form&_tab=views&menu_id={self.testMenu.id}"
