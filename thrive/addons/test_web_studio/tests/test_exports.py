...
from thrive.addons.web_studio.controllers.export import ir_model_data_getter, generate_module, _clean_dependencies
...
IR_MODEL_INFO_FIELD = """<field name="info"><![CDATA[ Main super-class for regular database-persisted Thrive models.
