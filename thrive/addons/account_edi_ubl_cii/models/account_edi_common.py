...
from thrive.tools import float_repr, format_list
from thrive.tools.float_utils import float_round
from thrive.tools.misc import formatLang, html_escape
from thrive.tools.xml_utils import find_xml_value
...
class AccountEdiCommon(models.AbstractModel):
    ...
    def _retrieve_taxes(self, record, line_values, tax_type):
        ...
        In a UBL/CII xml, the Thrive "price_include" concept does not exist. Hence, first look for a price_include=False,
    ...
    def _retrieve_line_charges(self, record, line_values, taxes):
        ...
        Special case: if the ReasonCode == 'AEO', there is a high chance the xml was produced by Thrive and the
