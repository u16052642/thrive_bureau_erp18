...
for record in records:
    ...
    @mute_logger('thrive.addons.base.models.ir_model',
                 'thrive.addons.mail.models.mail_mail',
                 'thrive.addons.mass_mailing.models.mailing',
                 'thrive.addons.mass_mailing_sms.models.mailing_mailing')
    ...
    def test_marketing_automation_flow(self):
        ...
        self._clear_outgoing_sms()
        with freeze_time(date_reference_new), \
             mute_logger('thrive.addons.marketing_automation.models.marketing_activity'), \
             self.capture_triggers('marketing_automation.ir_cron_campaign_execute_activities') as captured_triggers:
            campaign.execute_activities()
