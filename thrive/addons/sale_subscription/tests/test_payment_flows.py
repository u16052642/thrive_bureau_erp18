...
from thrive.addons.sale_subscription.tests.test_sale_subscription import TestSubscriptionCommon
...
class TestSubscriptionPaymentFlows(TestSubscriptionCommon, PaymentHttpCommon):
    ...
    def test_assign_token_maximum_amount(self):
        ...
        with self.assertRaisesRegex(JsonRpcException, "thrive.exceptions.UserError"):
