...
from thrive.addons.account_accountant.tests.test_signature import TestInvoiceSignature
...
from thrive.tests import Form, tagged, freeze_time
...
class TestSubscription(TestSubscriptionCommon, MockEmail):
    ...
    def setUp(self):
        ...
        self.post_process_patcher = patch(
            'thrive.addons.account_payment.models.payment_transaction.PaymentTransaction._post_process',
        )
...
class TestSubscriptionInvoiceSignature(TestInvoiceSignature, TestSubscription):
    ...
    def test_subscription_automated_invoice_should_have_signing_user_set_to_salesman(self):
        ...
        self.assertEqual(
            inv.signing_user,
            self.another_user,
            "When the invoice is posted by thrivebot, the signer should be the one that confirmed the subscription"
        )
