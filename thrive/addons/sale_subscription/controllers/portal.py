...
from thrive.addons.sale.controllers import portal as payment_portal
...
from thrive.addons.sale_subscription.models.sale_order import SUBSCRIPTION_PROGRESS_STATE, SUBSCRIPTION_CLOSED_STATE
...
class CustomerPortal(payment_portal.PaymentPortal):
    ...
    def subscription(self, order_id, access_token=None, message='', report_type=None, download=False, **kw):
        ...
        backend_url = f'/thrive/action-{order_sudo._get_portal_return_action().id}/{order_sudo.id}'
