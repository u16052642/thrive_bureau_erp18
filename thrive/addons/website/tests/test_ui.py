...
class TestUiHtmlEditor(HttpCaseWithUserDemo):
    ...
    def test_code_editor_usable(self):
        ...
        url = '/thrive/action-website.website_preview'
        self.start_tour(url, 'website_code_editor_usable', login='admin')


@thrive.tests.tagged('external', '-standard', '-at_install', 'post_install')
...
class TestUi(thrive.tests.HttpCase):
    ...
    def test_01_admin_tour_homepage(self):
        self.start_tour("/thrive", 'homepage', login='admin')
    ...
    def test_10_website_conditional_visibility(self):
        ...
        self.start_tour('/thrive', 'conditional_visibility_2', login='admin')
    ...
    def test_19_website_page_options(self):
        self.start_tour("/thrive", "website_page_options", login="admin")
    ...
    def test_21_website_start_cloned_snippet(self):
        self.start_tour('/thrive', 'website_start_cloned_snippet', login='admin')

    def test_22_website_gray_color_palette(self):
        self.start_tour('/thrive', 'website_gray_color_palette', login='admin')
    ...
    def test_27_website_clicks(self):
        self.start_tour('/thrive', 'website_click_tour', login='admin')
