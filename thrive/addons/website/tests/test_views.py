...
from thrive.modules.module import _DEFAULT_MANIFEST
...
class TestThemeViews(common.TransactionCase):
    def test_inherit_specific(self):
        ...
        patcher = patch('thrive.modules.module._get_manifest_cached', return_value=copy.deepcopy(_DEFAULT_MANIFEST))
