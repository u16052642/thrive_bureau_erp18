...
from thrive import api, fields, models, tools, release
...
from thrive.osv.expression import AND, OR, FALSE_DOMAIN
from thrive.tools import SQL, Query, sql as sqltools
...
class Website(models.Model):
        ...
        for model_name, field_name in html_fields:
            ...
            if dependency_records:
                ...
                dependencies[model_name] += [{
                    ...
                    'link': 'website_url' in rec and rec.website_url or f'/thrive/{model_name}/{rec.id}',
    ...
    def get_website_page_ids(self):
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the Thrive framework works.
    ...
    def get_client_action_url(self, url, mode_edit=False):
        ...
        return "/thrive/action-website.website_preview?" + urls.url_encode(action_params)
