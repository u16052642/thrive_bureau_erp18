...
registry.Parallax = Animation.extend({
    ...
    _updateBgCss(cssValues) {
        ...
        if (this.options.wysiwyg) {
            this.options.wysiwyg.thriveEditor.observerUnactive('_updateBgCss');
        }
        this.$bg.css(cssValues);
        if (this.options.wysiwyg) {
            this.options.wysiwyg.thriveEditor.observerActive('_updateBgCss');
        }
    },
...
registry.ImagesLazyLoading = publicWidget.Widget.extend({
    ...
    _updateImgMinHeight(imgEl, reset = false) {
        if (this.options.wysiwyg) {
            this.options.wysiwyg.thriveEditor.observerUnactive('_updateImgMinHeight');
        }
        if (reset) {
        ...
        if (this.options.wysiwyg) {
            this.options.wysiwyg.thriveEditor.observerActive('_updateImgMinHeight');
        }
    },
});
