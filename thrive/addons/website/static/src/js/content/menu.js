...
publicWidget.registry.MegaMenuDropdown = publicWidget.Widget.extend({
    ...
    _moveMegaMenu(megaMenuToggleEl) {
        ...
        this.options.wysiwyg?.thriveEditor.observerUnactive("moveMegaMenu");
        ...
        this.options.wysiwyg?.thriveEditor.observerActive("moveMegaMenu");
    },
...
publicWidget.registry.HeaderGeneral = publicWidget.Widget.extend({
     ...
     */
    _onCollapseShow() {
        this.options.wysiwyg?.thriveEditor.observerUnactive("addCollapseClass");
        this.el.classList.add('o_top_menu_collapse_shown');
        this.options.wysiwyg?.thriveEditor.observerActive("addCollapseClass");
    },
    /**
     * @private
     */
    _onCollapseHidden() {
        this.options.wysiwyg?.thriveEditor.observerUnactive("removeCollapseClass");
        ...
        this.options.wysiwyg?.thriveEditor.observerActive("removeCollapseClass");
    },
});
