...
registerWebsitePreviewTour('link_tools', {
    ...
    },
    {
        ...
        run: 'edit thrivebureau.com',
    },
    clickOnImgStep,
    // Remove the link.
    {
        content: "Click on the newly created link",
        trigger: ':iframe #wrap .s_text_image a[href="http://thrivebureau.com"]:contains("thrivebureau.com")',
        run: 'click',
    },
    {
    ...
    },
    {
        ...
        trigger: ':iframe #wrap .s_text_image p:contains("Go to thrive:"):not(:has(a))',
    },
    // Recreate the link.
    {
    ...
    },
    {
        ...
        trigger: '#o_link_dialog_label_input:value(thrivebureau.com)',
        run: 'edit thrive website_2',
    },
    {
    ...
    },
    {
        ...
        trigger: '#o_link_dialog_label_input:value(thrive website)',
    },
    {
        content: "Link tools, should be open, change the url",
        trigger: '#o_link_dialog_url_input',
        run: "edit thrive.be && click body",
    },
    ...
    },
    {
        ...
        // TODO: remove && click 
        run: "edit thrivebureau.com && click(we-title:contains(Your URL))",
    },
    {
    ...
    clickOnElement("card's text", ":iframe header .s_mega_menu_cards span"),
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: "edit https://www.thrivebureau.com",
    },
    {
        content: "Check nothing is lost",
        trigger: ":iframe header .s_mega_menu_cards a[href='https://www.thrivebureau.com']:has(img):has(h4):has(span)",
    },
    ...
    },
    {
        ...
        trigger: ":iframe .s_text_image p a[href='http://thrivebureau.com']",
        run: "click",
    },
    // 8. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("https://thrivebureau.com")
            // To see what happens with edit, add `pause:true` to the previous step 
            // and type yourself https://thrivebureau.com in #o_link_dialog_url_input  
            // The label will be ohttps://
            this.anchor.value = "https://thrivebureau.com";
    ...
    },
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("http://thrivebureau.com")
            this.anchor.value = "http://thrivebureau.com";
            this.anchor.dispatchEvent(new InputEvent("input", { bubbles: true }));
        }
    },
    {
    ...
    // TODO this step which was added by https://github.com/thrive/thrivebureau.commit/9fc283b514d420fdfd66123845d9ec3563572692
