...
class TestL10nMXTrialBalanceMonth13(TestAccountReportsCommon, thrive.tests.HttpCase):
    ...
    def test_tour_trial_balance_month13_date_filter(self):
        ...
        with freeze_time('2022-06-01'):
            self.start_tour("/thrive", 'trial_balance_month_13_date_filter', login=self.env.user.login)
