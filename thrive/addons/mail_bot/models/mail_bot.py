...
class MailBot(models.AbstractModel):
    ...
    def _get_style_dict():
        return {
            ...
            "bold_start": Markup("<b>"),
            "bold_end": Markup("</b>"),
            "command_start": Markup("<span class='o_thrivebot_command'>"),
            "command_end": Markup("</span>"),
            "document_link_start": Markup("<a href='https://www.thrivebureau.com/documentation' target='_blank'>"),
            "document_link_end": Markup("</a>"),
            "slides_link_start": Markup("<a href='https://www.thrivebureau.com/slides' target='_blank'>"),
    ...
    def _get_answer(self, record, body, values, command=False):
        ...
        if self._is_bot_in_private_channel(record):
            ...
            if thrivebot_state == 'onboarding_emoji' and self._body_contains_emoji(body):
                ...
                return html_escape(
                    _("Wow you are a natural!%(new_line)sPing someone with @username to grab their attention. "
                      "%(bold_start)sTry to ping me using%(bold_end)s %(command_start)s@ThriveBot%(command_end)s"
            ...
            elif thrivebot_state == "onboarding_canned" and self.env.context.get("canned_response_ids"):
                ...
                return html_escape(
                    _("Good, you can customize canned responses in the Discuss application."
                      ...
                      " Enjoy discovering Thrive!")) % self._get_style_dict()
                ...
                if thrivebot_state == 'onboarding_emoji':
                    ...
                    return html_escape(
                        _("Sorry, I am not listening. To get someone's attention, %(bold_start)sping him%(bold_end)s."
                          " Write %(command_start)s@ThriveBot%(command_end)s and select me.")) % self._get_style_dict()
