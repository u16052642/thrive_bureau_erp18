...
from thrive.addons.payment_flutterwave.tests.common import FlutterwaveCommon
...
class TestPaymentTransaction(FlutterwaveCommon):
    ...
    def test_no_item_missing_from_rendering_values(self):
        ...
        with patch(
            'thrive.addons.payment_flutterwave.models.payment_provider.PaymentProvider'
    ...
    def test_no_input_missing_from_redirect_form(self):
        ...
        tx = self._create_transaction(flow='redirect')
        with patch(
            'thrive.addons.payment_flutterwave.models.payment_transaction.PaymentTransaction'
