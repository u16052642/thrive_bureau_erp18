...
from thrive.tools import format_date, format_datetime, format_time, frozendict
from thrive.tools.mail import is_html_empty, html_to_inner_content
...
class EventEvent(models.Model):
    ...
    def get_kiosk_url(self):
        return self.get_base_url() + "/thrive/registration-desk"
    ...
    def _get_printing_sponsor_text(self):
        ...
        return sponsor_text or "Powered by Thrive"
