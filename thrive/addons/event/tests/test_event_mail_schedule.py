...
from thrive.tests import tagged, users, warmup
...
class TestMailSchedule(EventCase, MockEmail, CronMixinCase):
    ...
    @mute_logger(
        'thrive.addons.event.models.event_mail',
        'thrive.addons.event.models.event_mail_registration',
        'thrive.addons.event.models.event_registration',
    )
