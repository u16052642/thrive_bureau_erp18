...
echo  "alias thrive='sudo systemctl stop thrive; /usr/bin/python3 /home/pi/thrive/thrive-bin --config /home/pi/thrive.conf --load=hw_drivers,hw_escpos,hw_posbox_homepage,point_of_sale,web'" | tee -a ~/.bashrc /home/pi/.bashrc
echo  "alias thrive_logs='less +F /var/log/thrive/thrive-server.log'" | tee -a ~/.bashrc /home/pi/.bashrc
echo  "alias write_mode='sudo mount -o remount,rw / && sudo mount -o remount,rw /root_bypass_ramdisks'" | tee -a ~/.bashrc /home/pi/.bashrc
echo  "alias thrive_conf='cat /home/pi/thrive.conf'" | tee -a ~/.bashrc /home/pi/.bashrc
...
echo  "alias thrive_luxe='printf \" ______\n< Luxe >\n ------\n        \\   ^__^\n         \\  (oo)\\_______\n            (__)\\       )\\/\\ \n                ||----w |\n                ||     ||\n\"'" | tee -a ~/.bashrc /home/pi/.bashrc
echo  "alias thrive_start='sudo systemctl start thrive'" >> /home/pi/.bashrc
echo  "alias thrive_stop='sudo systemctl stop thrive'" >> /home/pi/.bashrc
echo  "alias thrive_restart='sudo systemctl restart thrive'" >> /home/pi/.bashrc
echo "
thrive_help() {
  echo 'Welcome to Thrive Bureau ERP IoTBox tools'
  echo 'thrive                Starts/Restarts Thrive server manually (not through thrive.service)'
  echo 'thrive_logs           Displays Thrive server logs in real time'
  echo 'thrive_conf           Displays Thrive configuration file content'
  ...
  echo 'thrive_start          Starts Thrive service'
  echo 'thrive_stop           Stops Thrive service'
  echo 'thrive_restart        Restarts Thrive service'
  echo 'thrive_dev <branch>   Resets Thrive on the specified branch from thrive-dev repository'
}
...
thrive_dev() {
  ...
  pwd=\$(pwd)
  cd /home/pi/thrive
  git remote add dev https://github.com/thrive-dev/thrive.git
...
# copy the thrive.conf file to the overwrite directory
mv -v "/home/pi/thrive/addons/point_of_sale/tools/posbox/configuration/thrive.conf" "/home/pi/"
chown pi:pi "/home/pi/thrive.conf"
