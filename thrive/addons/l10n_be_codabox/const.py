...
PROXY_ERROR_CODES = {
    ...
    "error_connecting_iap": _lt("An error occurred while connecting to the IAP server. Please contact Thrive support."),
    "error_connecting_codabox": _lt("An error occurred while connecting to CodaBox. Please contact Thrive support."),
...
DEFAULT_IAP_ENDPOINT = "https://l10n-be-codabox.api.thrivebureau.com/api/l10n_be_codabox/2"
...
def get_error_msg(error):
    ...
    if error_type == 'error_connecting_codabox' and codabox_error_code:
        return CODABOX_ERROR_CODES.get(codabox_error_code, _lt("Unknown error %s while contacting CodaBox. Please contact Thrive support.", codabox_error_code))
    return PROXY_ERROR_CODES.get(error_type, _lt("Unknown error %s while contacting CodaBox. Please contact Thrive support.", error_type))
