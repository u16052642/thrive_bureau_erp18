...
from thrive.addons.l10n_be_codabox.const import get_error_msg
...
class L10nBeCodaBoxConnectionWizard(models.TransientModel):
    ...
    fidu_password = fields.Char(
        ...
        help='This is the password you have received from Thrive Bureau ERP the first time you connected to CodaBox.'
