...
from thrive.addons.l10n_cl_edi.tests.common import TestL10nClEdiCommon, _check_with_xsd_patch, _is_valid_certificate
...
class TestL10nClExportsDte(TestL10nClEdiCommon):
    ...
    @patch('thrive.addons.certificate.models.certificate.Certificate._compute_is_valid', _is_valid_certificate)
