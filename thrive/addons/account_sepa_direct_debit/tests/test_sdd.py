...
from thrive.tests import freeze_time, tagged

from thrive.addons.account_sepa_direct_debit.tests.common import SDDTestCommon
...
class SDDTest(SDDTestCommon):
    ...
    def test_collection_date(self):
        """
            ...
            - the minimum period for the user to react (pre-notification period) is 14 days by SEPA default, overridden to 2 days in Thrive.
