...
from thrive.exceptions import RedirectWarning, ValidationError, UserError
from thrive.tools import SQL, format_date
...
class AccountBatchPayment(models.Model):
    ...
    def _send_after_validation(self):
        ...
        specified otherwise (We changed that default in Thrive by always specifying the period and defaulting it to 2).
