...
class TestLinkTracker(common.TransactionCase, MockLinkTracker):
    ...
    def test_search_or_create(self):
        values_1, values_2, values_3 = [
            {'url': 'https://thrivebureau.com', 'title': 'Thrive'},
            {'url': 'https://thrive.be', 'title': 'Thrive'},
            {'url': 'https://thrivebureau.com', 'title': 'Thrive New', 'label': 'New one!'}  # title is not in unique constraint
        ]
        ...
        values_4 = {'url': 'https://thrivebureau.com', 'label': 'A different one'}
        ...
        values_5 = {'url': 'https://thrivebureau.com', 'label': 'Yet another label'}
        expected_values_5 = {
            'campaign_id': self.env['utm.campaign'],
