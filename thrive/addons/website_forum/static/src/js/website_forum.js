/** @thrive-module **/
import { Component, useState, markup, onWillStart } from "@thrive/owl";
...
publicWidget.registry.websiteForum = publicWidget.Widget.extend({
    ...
    async start() {
        ...
        var forumLogin = `${window.location.origin}/thrive?redirect=${encodeURIComponent(window.location.href)}`
