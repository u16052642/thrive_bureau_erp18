...
import { click, edit, keyDown, keyUp, press, queryOne } from "@thrive/hoot-dom";
import { animationFrame, runAllTimers } from "@thrive/hoot-mock";
import {
    contains,
    defineWebModels,
    mountWithCleanup,
...
test("Click on element with unique thrive class", async () => {
...
test("Click on element with no unique thrive class", async () => {
    await mountWithCleanup(
        `
        <div class="o_parent">
            <div class="o_child_1 click"></div>
...
test("Find the nearest thrive class", async () => {
