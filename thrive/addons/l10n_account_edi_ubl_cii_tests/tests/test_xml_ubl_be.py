...
class TestUBLBE(TestUBLCommon, TestAccountMoveSendCommon):
    ...
    def test_sending_to_public_admin(self):
        ...
        check_attachment(invoice1, "from_thrive/bis3_out_invoice_public_admin_1.xml")
        # Switch the partner's roles
        invoice2 = self._generate_move(self.partner_2, self.partner_1, **invoice_vals)
        check_attachment(invoice2, "from_thrive/bis3_out_invoice_public_admin_2.xml")
    ...
    def test_inverting_negative_price_unit(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_thrive/bis3_out_invoice_negative_unit_price.xml')
    ...
    def test_export_with_fixed_taxes_case4(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_thrive/bis3_ecotaxes_case4.xml')
    ...
    def test_export_with_changed_taxes(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_thrive/bis3_export_with_changed_taxes.xml')
    ...
    def test_export_tax_exempt(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_thrive/bis3_out_invoice_tax_exempt.xml')
