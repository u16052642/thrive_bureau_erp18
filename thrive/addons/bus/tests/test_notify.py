...
from ..models.bus import json_dump, get_notify_payloads, NOTIFY_PAYLOAD_MAX_LENGTH, THRIVE_NOTIFY_FUNCTION
...
class NotifyTests(TransactionCase):
    ...
    def test_postcommit(self):
        ...
        if THRIVE_NOTIFY_FUNCTION != 'pg_notify':
            return
        channels = []
