...
from thrive.addons.l10n_ec.models.res_partner import PartnerIdTypeEc
from thrive.addons.l10n_ec_edi.models.account_move import L10N_EC_VAT_SUBTAXES, L10N_EC_VAT_RATES
...
class L10nEcReimbursement(models.Model):
    ...
    def _get_identification_type(self):
        """Maps Thrive identification types to Ecuadorian ones. In reimbursements can be only ruc or vat"""
        id_type_xmlid = False
