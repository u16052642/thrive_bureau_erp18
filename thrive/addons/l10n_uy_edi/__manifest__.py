{
    ...
    "version": "1.0",
    "description": """
This module integrate Thrive so you can issue electronic documents (CFE) to DGI. Example: e-Ticket, e-Invoice and related Debit and Credit Notes.

After the CFE has been issued, and since the invoice validation is asynchronous, Thrive will run a scheduled action that will connect to DGI to check/update CFE state (Waiting DGI Response, Approved or Rejected)
