...
class AccountJournal(models.Model):
    ...
    l10n_uy_edi_type = fields.Selection(
        ...
        "* Electronic: To generate electronic documents via web service to DGI directly from Thrive Bureau ERP\n"
        "* Manual: To add electronic documents that were created previously outside Thrive (example: backups,"
