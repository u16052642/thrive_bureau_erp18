...
class ResCompany(models.Model):
    ...
    l10n_uy_edi_ucfe_env = fields.Selection(
        ...
        " it will do a dummy validation only in Thrive of the CFE")
    l10n_uy_edi_ucfe_password = fields.Char(
        ...
        " exchange between Thrive and Uruware. It is distinct from the password used to log in to Uruware's portal.")
