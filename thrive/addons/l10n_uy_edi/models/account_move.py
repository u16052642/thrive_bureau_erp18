...
from thrive.tools import float_repr, float_round, cleanup_xml_node, format_amount, html2plaintext
...
class AccountMove(models.Model):
    ...
    def _get_l10n_latam_documents_domain(self):
        # EXTEND l10n_latam_invoice_document
        """ Only return the implemented electronic document types so far if the user want to issue from Thrive Bureau ERP """
        self.ensure_one()
    ...
    def _l10n_uy_edi_cfe_B_details(self, tax_details):
        ...
        Check the restriction on the maximum number of lines that we can report, launch a prior exception from Thrive Bureau ERP
    ...
    def _l10n_uy_edi_dummy_validation(self):
        """ When we want to skip DGI and validate only in Thrive """
