...
from thrive import conf, fields, http, _
...
from thrive.tools import replace_exceptions, str2bool, consteq
...
class ShareRoute(http.Controller):
    ...
    def _make_zip(self, name, documents):
        ...
        :param thrive.models.Model documents: documents to load in the ZIP
    ...
    def documents_home(self, access_token):
        ...
        if request.env.user._is_public():
            ...
            # Internal users use the /thrive/documents/<access_token> route
            return request.redirect(
                f'/thrive/documents/{access_token}',
    ...
    def _documents_render_public_view(self, document_sudo):
        ...
        if (
            ...
            return request.redirect(f'/thrive/documents/{target_sudo.access_token}')
    ...
    def documents_redirect(self, access_token):
        return request.redirect(f'/thrive/documents/{access_token}', HTTPStatus.MOVED_PERMANENTLY)
    ...
    def documents_download_all_legacy(self, access_token=None, share_id=None):
        logger.warning("Deprecated since Thrive 18. Please access /documents/content/<access_token> instead.")
    ...
    def share_portal(self, share_id=None, token=None):
        logger.warning("Deprecated since Thrive 18. Please access /thrive/documents/<access_token> instead.")
        return request.redirect(f'/thrive/documents/{token}', code=HTTPStatus.MOVED_PERMANENTLY)
