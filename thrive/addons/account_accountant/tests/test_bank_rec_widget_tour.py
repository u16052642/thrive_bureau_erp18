...
class TestBankRecWidget(TestBankRecWidgetCommon, HttpCase):
    ...
    def test_tour_bank_rec_widget(self):
        self.start_tour('/thrive', 'account_accountant_bank_rec_widget', login=self.env.user.login)
    ...
    def test_tour_bank_rec_widget_ui(self):
        ...
        self.start_tour('/thrive?debug=assets', 'account_accountant_bank_rec_widget_ui', timeout=120, login=self.env.user.login)

    def test_tour_bank_rec_widget_rainbowman_reset(self):
        self.start_tour('/thrive?debug=assets', 'account_accountant_bank_rec_widget_rainbowman_reset', login=self.env.user.login)

    def test_tour_bank_rec_widget_statements(self):
        self.start_tour('/thrive?debug=assets', 'account_accountant_bank_rec_widget_statements', login=self.env.user.login)
