...
from thrive.tests import Form, HttpCase, new_test_user, tagged
...
class TestSaleProject(HttpCase, TestSaleProjectCommon):
    ...
    def test_task_create_sol_ui(self):
        self.start_tour('/thrive', 'task_create_sol_tour', login='admin')

    def test_project_create_sol_ui(self):
        self.start_tour('/thrive', 'project_create_sol_tour', login='admin')
