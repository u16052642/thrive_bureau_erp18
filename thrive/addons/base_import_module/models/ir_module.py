...
from thrive.modules.module import adapt_version, MANIFEST_NAMES
    ...
    def _get_missing_dependencies(self, zip_data):
        ...
        if unavailable_modules:
            ...
            description += _(
                ...
                "https://www.thrivebureau.com/pricing-plan for more information.\n"
                "If you need Website themes, it can be downloaded from https://github.com/thrive/design-themes.\n"
            )
        elif modules:
