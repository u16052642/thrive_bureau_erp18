...
registry.category("web_tour.tours").add("web_studio.test_basic_report_edition", {
    ...
    steps: () => [
        ...
        {
            trigger: ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable p:eq(0)",
            run: "editor edited with thrive editor",
        },
        {
            trigger: ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable p:eq(2)",
            run: "editor edited with thrive editor 2",
        },
        {
...
registry.category("web_tour.tours").add("web_studio.test_basic_report_edition_cancel_discard", {
    ...
    steps: () => [
        ...
        },
        {
            trigger: ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable p:eq(0)",
            run() {
                assertEqual(this.anchor.textContent, "edited with thrive editor");
            },
        },
        {
            trigger: ".o-web-studio-save-report.btn-primary",
...
registry.category("web_tour.tours").add("web_studio.test_basic_report_edition_error", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger: ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable",
            run() {
...
registry.category("web_tour.tours").add("web_studio.test_report_reset_archs", {
    ...
    steps: () => [
        ...
        {
            trigger: ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable p:eq(1)",
            run() {
...
registry.category("web_tour.tours").add("web_studio.test_table_rendering", {
    ...
    steps: () => [
        {
            trigger:
                ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable .valid_table",
            run() {
                assertEqual(
        ...
        {
            trigger:
                ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable .invalid_table",
            run() {
                assertEqual(
                    this.anchor.outerHTML.replace(/\n\s*/g, ""),
        ...
        {
            trigger:
                ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable .invalid_table q-td",
            run: "editor edited with thriveEditor",
        },
        {
            trigger: ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable p:eq(1)",
            run: "editor p edited with thriveEditor",
        },
        {
            trigger: ".o_web_studio_sidebar input[id='name']",
...
registry.category("web_tour.tours").add("web_studio.test_field_placeholder", {
    ...
    steps: () => [
        ...
        {
            trigger:
                ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable span[t-field='doc.function'][title='doc.function']",
        },
        {
            trigger: ".o-web-studio-save-report.btn-primary",
        },
        {
            trigger: ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable p:eq(0)",
            run() {
                insertText(this.anchor, "edited with thriveEditor");
            },
        },
        {
            trigger: ".o-web-studio-save-report.btn-primary",
...
registry.category("web_tour.tours").add("web_studio.test_add_field_blank_report", {
    ...
    steps: () => [
        ...
        {
            trigger: ":iframe .thrive-editor-editable .page div",
            async run(helpers) {
                const el = this.anchor;
                openEditorPowerBox(el);
            },
        ...
        },
        {
            ...
            trigger: ":iframe .thrive-editor-editable .page div > span:contains(some default value)",
        },
        {
            trigger: ":iframe .thrive-editor-editable .page div",
            run() {
...
registry.category("web_tour.tours").add("web_studio.test_toolbar_appearance", {
    ...
    steps: () => [
        {
            trigger: ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable .to_edit",
            run() {
...
registry.category("web_tour.tours").add("web_studio.test_partial_eval", {
    ...
    steps: () => [
        {
            trigger: ".o-web-studio-report-container :iframe .thrive-editor-editable .lol",
            run() {
        ...
        {
            trigger: ".o-web-studio-report-container :iframe .thrive-editor-editable .couic",
        },
    ],
});
...
registry.category("web_tour.tours").add("web_studio.test_render_multicompany", {
    ...
    steps: () => [
        {
            trigger: ".o-web-studio-report-container :iframe .thrive-editor-editable .test_layout",
        },
        {
            trigger: ".o-web-studio-report-container :iframe .thrive-editor-editable img",
            run() {
...
registry.category("web_tour.tours").add("web_studio.test_report_edition_dynamic_table", {
    ...
    steps: () => [
        ...
        {
            trigger:
                ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable table tr td:contains(First Column)",
        },
        {
            trigger:
                ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable table tr[t-foreach]",
            run() {
                const el = this.anchor;
        ...
        {
            trigger:
                ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable table tr td:contains(Insert a field...)",
            run() {
        ...
        {
            trigger:
                ".o-web-studio-report-editor-wysiwyg :iframe .thrive-editor-editable table td span[t-field='x2many_record.summary']",
        },
        {
            trigger: ".o-web-studio-save-report.btn-primary",
            run: "click",
...
registry.category("web_tour.tours").add("web_studio.test_error_at_loading_debug", {
    ...
    steps: () => [
        ...
        {
            trigger:
                ".o-web-studio-report-container strong:contains(thrive.addons.base.models.ir_qweb.QWebException)",
        },
    ],
});
...
registry.category("web_tour.tours").add("web_studio.test_remove_branding_on_copy", {
    ...
    steps: () => [
        {
            trigger: "body :iframe .thrive-editor-editable#wrapwrap",
            async run() {
...
registry.category("web_tour.tours").add("web_studio.test_edit_main_arch", {
    ...
    steps: () => [
        {
            trigger: ":iframe .thrive-editor-editable .outside-t-call",
            async run() {
                const doc = this.anchor.ownerDocument;
                const editor = editorsWeakMap.get(doc);
...
registry.category("web_tour.tours").add("web_studio.test_edit_in_t_call", {
    ...
    steps: () => [
        {
            trigger: ":iframe .thrive-editor-editable .in-t-call",
            async run() {
                const doc = this.anchor.ownerDocument;
                const editor = editorsWeakMap.get(doc);
                const newNode = doc.createElement("div");
...
registry.category("web_tour.tours").add("web_studio.test_edit_main_and_in_t_call", {
    ...
    steps: () => [
        {
            trigger: ":iframe .thrive-editor-editable#wrapwrap",
            async run() {
                const doc = this.anchor.ownerDocument;
                const editor = editorsWeakMap.get(doc);
...
registry.category("web_tour.tours").add("web_studio.test_image_crop", {
    ...
    steps: () => [
        {
            trigger: "body :iframe .thrive-editor-editable .myimg",
            run: "click",
        },
        {
...
registry.category("web_tour.tours").add("web_studio.test_translations_are_copied", {
    ...
    steps: () => [
        {
            trigger: "body :iframe .thrive-editor-editable#wrapwrap div:contains(term2)",
            run() {
                const doc = this.anchor.ownerDocument;
                const editor = editorsWeakMap.get(doc);
                const newNode = doc.createElement("div");
