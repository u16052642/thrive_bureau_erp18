...
class TestUi(thrive.tests.HttpCase):
    ...
    def test_new_app_and_report(self):
        if not thrive.tests.loaded_demo_data(self.env):
            ...
            return
        self.start_tour("/thrive", 'web_studio_new_app_tour', login="admin")

        # the new submenu tour is based on the result of the new app tour
        self.start_tour("/thrive", 'web_studio_new_submenu_tour', login="admin")

        # the report tour is based on the result of the new app tour
        self.start_tour("/thrive?debug=tests", 'web_studio_new_report_tour', login="admin")
        self.start_tour("/thrive?debug=tests", "web_studio_new_report_basic_layout_tour", login="admin")

    def test_optional_fields(self):
        self.start_tour("/thrive?debug=tests", 'web_studio_hide_fields_tour', login="admin")

    def test_model_option_value(self):
        self.start_tour("/thrive?debug=tests", 'web_studio_model_option_value_tour', login="admin")

    def test_rename(self):
        self.start_tour("/thrive?debug=tests", 'web_studio_main_and_rename', login="admin", timeout=200)

    def test_approval(self):
        self.start_tour("/thrive?debug=tests", 'web_studio_approval_tour', login="admin")
    ...
    def test_background(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_custom_background_tour', login="admin")

    def test_create_app_with_pipeline_and_user_assignment(self):
        self.start_tour("/thrive?debug=tests", 'web_studio_create_app_with_pipeline_and_user_assignment', login="admin")
    ...
    def test_alter_field_existing_in_multiple_views(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_alter_field_existing_in_multiple_views_tour', login="admin")
    ...
    def test_add_field_into_empty_group_by(self):
        self.start_tour("/thrive?debug=tests", 'web_studio_add_field_into_empty_group_by', login="admin")
...
class TestStudioUIUnit(thrive.tests.HttpCase):
    ...
    def test_web_studio_check_method_in_model(self):
        self.start_tour("/thrive?debug=tests", 'web_studio_check_method_in_model', login="admin")

    def test_create_action_button_in_form_view(self):
        self.start_tour("/thrive?debug=tests", 'web_studio_test_create_action_button_in_form_view', login="admin")
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_create_second_action_button_in_form_view', login="admin")
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_remove_action_button_in_form_view', login="admin")
        self.start_tour("/thrive?debug=tests", 'web_studio_test_remove_action_button_in_form_view', login="admin")
        arch = """<data>
                <xpath expr="//form[1]/field[@name='name']" position="before">
                    <header/>
    ...
    def test_create_action_button_in_list_view(self):
        self.start_tour("/thrive?debug=tests", 'web_studio_test_create_action_button_in_list_view', login="admin")
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_remove_action_button_in_list_view', login="admin")
        arch = """<data>
                <xpath expr="//field[@name='complete_name']" position="before">
                    <header/>
                </xpath>
    ...
    def test_form_view_not_altered_by_studio_xml_edition(self):
        self.start_tour("/thrive?debug=tests", 'web_studio_test_form_view_not_altered_by_studio_xml_edition', login="admin", timeout=200)
    ...
    def test_edit_with_xml_editor(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_edit_with_xml_editor', login="admin", timeout=200)
    ...
    def test_enter_x2many_edition_and_add_field(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_enter_x2many_edition_and_add_field', login="admin", timeout=200)
        studioView = _get_studio_view(self.testView)
    ...
    def test_enter_x2many_auto_inlined_subview(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_enter_x2many_auto_inlined_subview', login="admin", timeout=200)
        studioView = _get_studio_view(self.testView)
    ...
    def test_enter_x2many_auto_inlined_subview_with_multiple_field_matching(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_enter_x2many_auto_inlined_subview_with_multiple_field_matching',
    ...
    def test_field_with_group(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_field_with_group', login="admin", timeout=200)
    ...
    def test_studio_no_fetch_subview(self):
        ...
        self.start_tour("/thrive", 'web_studio_no_fetch_subview', login="admin")
    ...
    def test_elements_with_groups_form(self):
        ...
        self.start_tour("/thrive", 'web_studio_elements_with_groups_form', login="admin", timeout=600000)
        self.assertEqual(len(operations), 1)
    ...
    def test_element_group_in_sidebar(self):
        ...
        self.start_tour("/thrive?debug=tests", 'test_element_group_in_sidebar', login="admin", timeout=600000)
    ...
    def test_create_one2many_lines_then_edit_name(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_create_one2many_lines_then_edit_name', login="admin", timeout=30000)
    ...
    def test_address_view_id_no_edit(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_address_view_id_no_edit', login="admin", timeout=200)
    ...
    def test_custom_selection_field_edit_values(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_custom_selection_field_edit_values', login="admin", timeout=200)
    ...
    def test_create_new_model_from_existing_view(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_create_new_model_from_existing_view', login="admin",
                        timeout=200)

    def test_create_model_with_clickable_stages(self):
        self.start_tour("/thrive?debug=tests", 'web_studio_test_create_model_with_clickable_stages', login="admin", timeout=200)
    ...
    def test_enter_x2many_edition_with_multiple_subviews(self):
        ...
        '''.format(doesnothavegroup=doesNotHaveGroupXmlId.complete_name, hasgroup=hasGroupXmlId.complete_name)
        self.start_tour("/thrive?debug=tests", 'web_studio_test_enter_x2many_edition_with_multiple_subviews',
                        login="admin", timeout=200)
    ...
    def test_enter_x2many_edition_with_multiple_subviews_correct_xpath(self):
        ...
        '''.format(doesnothavegroup=doesNotHaveGroupXmlId.complete_name, hasgroup=hasGroupXmlId.complete_name)
        self.start_tour("/thrive?debug=tests", 'web_studio_test_enter_x2many_edition_with_multiple_subviews_correct_xpath',
                        login="admin", timeout=200)
        studioView = _get_studio_view(self.testView)
        assertViewArchEqual(self, studioView.arch, """
            <data>
    ...
    def test_set_tree_column_conditional_invisibility(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_set_tree_node_conditional_invisibility', login="admin", timeout=200)
    ...
    def test_studio_view_is_last(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_studio_view_is_last', login="admin", timeout=200)
        studioView = _get_studio_view(self.testView)
    ...
    def test_edit_form_subview_attributes(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_edit_form_subview_attributes', login="admin", timeout=200)
    ...
    def test_x2many_two_levels_edition(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_x2many_two_levels_edition', login="admin", timeout=200)
    ...
    def test_field_group_studio_no_fetch(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_field_group_studio_no_fetch', login="admin", timeout=200)
    ...
    def test_monetary_create(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_monetary_create', login="admin")
    ...
    def test_monetary_change_currency_name(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_monetary_change_currency_name', login="admin")
    ...
    def test_related_monetary_creation(self):
        ...
        '''
        self.start_tour("/thrive?debug=tests", 'web_studio_related_monetary_creation', login="admin")
    ...
    def test_monetary_change_currency_field(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_monetary_change_currency_field', login="admin")
    ...
    def test_monetary_change_currency_not_in_view(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_monetary_change_currency_not_in_view', login="admin")
    ...
    def test_monetary_add_existing_monetary(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_monetary_add_existing_monetary', login="admin")
    ...
    def test_monetary_create_monetary_with_existing_currency(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_monetary_create_monetary_with_existing_currency', login="admin")
    ...
    def test_move_similar_field(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_move_similar_field', login="admin", timeout=400)
    ...
    def test_related_binary_field_with_filename(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_related_file', login="admin", timeout=400)
    ...
    def test_undo_new_field(self):
        ...
        '''
        self.start_tour("/thrive?debug=tests", "web_studio_test_undo_new_field", login="admin", timeout=200)
    ...
    def test_change_lone_attr_modifier_form(self):
        ...
        self.start_tour("/thrive?debug=tests", "web_studio_test_change_lone_attr_modifier_form", login="admin")
        studioView = _get_studio_view(self.testView)
        assertViewArchEqual(self, studioView.arch, '''
        <data>
    ...
    def test_drag_and_drop_boolean(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_boolean_field_drag_and_drop', login="admin", timeout=200)
    ...
    def test_new_field_rename_description(self):
        ...
        self.start_tour("/thrive", "web_studio_test_new_field_rename_description", login="admin")
    ...
    def test_edit_digits_option(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_edit_digits_option', login="admin", timeout=200)
        studioView = _get_studio_view(self.testView)
        assertViewArchEqual(self, studioView.arch, """
            <data>
    ...
    def test_button_rainbow_effect(self):
        ...
        self.start_tour("/thrive", "web_studio.test_button_rainbow_effect", login="admin")
    ...
    def test_res_users_fake_fields(self):
        ...
        url = f"/thrive/action-studio?mode=editor&_tab=views&_view_type=list&_action={action.id}&debug=1"
    ...
    def test_reload_after_restoring_default_view(self):
        self.start_tour("/thrive?debug=tests", 'web_studio_test_reload_after_restoring_default_view', login="admin")
    ...
    def test_edit_reified_field(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_edit_reified_field', login="admin")
        studioView = _get_studio_view(self.testView)
        assertViewArchEqual(self, studioView.arch, """
            <data>
    ...
    def test_add_all_types_fields_related(self):
        self.create_user_view()
        self.start_tour("/thrive?debug=tests", 'web_studio_test_add_all_types_fields_related', login="admin")
    ...
    def test_add_many2one_without_related(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_add_one2many_no_related_many2one', login="admin")
    ...
    def test_approval_button_xml_id(self):
        ...
        """
        self.start_tour("/thrive?debug=tests", "web_studio_test_approval_button_xml_id", login="admin")
    ...
    def test_kanban_field_bold(self):
        ...
        self.testAction.view_ids.view_mode = "kanban"
        self.start_tour("/thrive?debug=tests", 'web_studio_test_kanban_field_bold', login="admin",
                        timeout=200)
        studioView = _get_studio_view(self.testView)
        self.assertXMLEqual(studioView.arch, """
            <data>
    ...
    def test_kanban_menu_ribbon(self):
        ...
        self.start_tour("/thrive?debug=tests", 'web_studio_test_kanban_menu_ribbon', login="admin")
