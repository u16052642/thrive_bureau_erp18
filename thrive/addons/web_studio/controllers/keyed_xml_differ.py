...
def _get_node_boundary_text(node: etree._Element, position: Literal["before", "after", "inside"]) -> str | None:
    ...
    to Thrive Bureau ERP's xpath semantics
...
class KeyedXmlDiffer:
    ...
    The `diff_xpath` method computes the Thrive's xpath notation to be used as an inherited view
    ...
    # Methods that concern the building of the Thrive's xpath semantic tree
