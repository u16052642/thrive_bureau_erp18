...
from thrive.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE, THAI_EMAIL_WINDOWS_874
from thrive.addons.test_mail.models.test_mail_models import MailTestGateway
from thrive.sql_db import Cursor
from thrive.tests import tagged, RecordCapturer
from thrive.tools import mute_logger
from thrive.tools.mail import email_split_and_format, formataddr
...
class TestMailgateway(MailCommon):
    ...
    def test_message_hebrew_iso8859_8_i(self):
        ...
        # python, check that Thrive is still capable of decoding it.
