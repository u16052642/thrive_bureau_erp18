...
class TestMessageValues(MailCommon):
    ...
    @mute_logger('thrive.models.unlink', 'thrive.addons.mail.models.models')
    @users('employee')
...
class TestMessageLinks(MailCommon, HttpCase):
    ...
    def test_message_link_by_employee(self):
        ...
        with self.subTest(thread_message=thread_message):
            expected_url = self.base_url() + f'/thrive/{thread_message.model}/{thread_message.res_id}?highlight_message_id={thread_message.id}'
        ...
        with self.subTest(channel_message=channel_message):
            expected_url = self.base_url() + f'/thrive/action-mail.action_discuss?active_id={channel_message.res_id}&highlight_message_id={channel_message.id}'
