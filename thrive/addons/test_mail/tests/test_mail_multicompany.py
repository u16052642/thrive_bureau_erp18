...
from thrive.addons.test_mail.models.test_mail_corner_case_models import MailTestMultiCompanyWithActivity
            ...
            with self.subTest(login=login, mc_record=mc_record):
                ...
                if not login:
                    ...
                    if mc_error:
                        ...
                        self.assertEqual(parsed_url.path, '/thrive/action-mail.action_discuss')
                    else:
