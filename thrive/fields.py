...
import typing
from thrive.api import ContextType, DomainType, IdType, NewId, M, T
...
class Field(MetaField('DummyField', (object,), {}), typing.Generic[T]):
    ...
    :param str aggregator: aggregate function used by :meth:`~thrive.models.Model.read_group`
    ...
    def _get_attrs(self, model_class, name):
        ...
        if 'group_operator' in attrs:
            warnings.warn("Since Thrive 18, 'group_operator' is deprecated, use 'aggregator' instead", DeprecationWarning, 2)
...
class Many2one(_Relational[M]):
    ...
    :param bool check_company: Mark the field to be verified in
        :meth:`~thrive.models.Model._check_company`. Has a different behaviour
