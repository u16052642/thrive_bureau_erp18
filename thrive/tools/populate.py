...
This tool provides utilities to duplicate records across models in Thrive, while maintaining referential integrity,
...
from thrive.fields import Field, Many2one
