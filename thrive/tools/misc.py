...
"""
Miscellaneous tools used by Thrive.
"""
...
from thrive.loglevels import exception_to_unicode, get_encodings, ustr  # noqa: F401
...
if typing.TYPE_CHECKING:
    ...
    from thrive.addons.base.models.res_lang import LangData
...
def file_path(file_path: str, filter_ext: tuple[str, ...] = ('',), env: Environment | None = None) -> str:
    ...
    addons_paths = [*thrive.addons.__path__, root_path, *temporary_paths]
