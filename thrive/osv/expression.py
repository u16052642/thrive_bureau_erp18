...
Thrive will use the SQL function 'unaccent' when available for the
...
from thrive.models import check_property_field_value_name, READ_GROUP_NUMBER_GRANULARITY
from thrive.tools import Query, SQL, get_lang
from thrive.tools.sql import pattern_to_translated_trigram_pattern, value_to_translated_trigram_pattern
...
def get_unaccent_wrapper(cr):
    ...
    return thrive.modules.registry.Registry(cr.dbname).unaccent
