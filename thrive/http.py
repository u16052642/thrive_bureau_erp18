...
class Stream:
    ...
    def from_path(cls, path, filter_ext=('',), public=False):
        ...
        :param path: See :func:`~thrive.tools.file_path`
        :param filter_ext: See :func:`~thrive.tools.file_path`
...
class Request:
    ...
    def _serve_db(self):
        ...
        try:
            ...
            self.env = thrive.api.Environment(cr_readonly, self.session.uid, self.session.context)
            try:
            ...
            try:
                ...
                if self.get_static_file(httprequest.path):
                    ...
                    try:
                        ...
                        if (httprequest.path.startswith('/thrive/')
                            or httprequest.path in (
                                '/thrive', '/web', '/web/login', '/test_http/ensure_db',
                            )):
