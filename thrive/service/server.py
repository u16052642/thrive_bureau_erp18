...
from thrive.tools.cache import log_ormcache_stats
from thrive.tools.misc import stripped_sys_argv, dumpstacks
...
def set_limit_memory_hard():
    ...
    if thrive.evented and config['limit_memory_hard_gevent']:
    ...
    def run(self, preload=None, stop=False):
        ...
        if stop:
            if config['test_enable']:
                from thrive.tests.result import _logger as logger  # noqa: PLC0415
...
def load_test_file_py(registry, test_file):
    ...
    from thrive.tests import loader  # noqa: PLC0415
    from thrive.tests.suite import ThriveSuite  # noqa: PLC0415
